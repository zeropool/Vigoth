...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class Quote : Message
	{
		...
		private QuoteQuoteQualifierList _listQuoteQualifier = new QuoteQuoteQualifierList();
		private int _iQuoteResponseLevel;
		private int _iNoPartyIDs;
		private QuotePartyIDList _listPartyID = new QuotePartyIDList();
		...
		private QuoteSecurityAltIDList _listSecurityAltID = new QuoteSecurityAltIDList();
		...
		private QuoteEventList _listEvent = new QuoteEventList();
		...
		private QuoteUnderlyingList _listUnderlying = new QuoteUnderlyingList();
		private char _cSide;
		...
		private QuoteStipulationList _listStipulation = new QuoteStipulationList();
		private string _sAccount;
		private int _iAcctIDSource;
		private int _iAccountType;
		private int _iNoLegs;
		private QuoteLegList _listLeg = new QuoteLegList();
		...
		public QuoteQuoteQualifierList QuoteQualifier 
		{
		...
		public QuotePartyIDList PartyID 
		{
		...
		public QuoteSecurityAltIDList SecurityAltID 
		{
		...
		public QuoteUnderlyingList Underlying 
		{
		...
		public QuoteStipulationList Stipulation 
		{
	...
	public class QuoteQuoteQualifier
	{
	...
	public class QuoteQuoteQualifierList
	{
		private ArrayList _al;
		private QuoteQuoteQualifier _last;

		public QuoteQuoteQualifier this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteQuoteQualifier)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteQuoteQualifier item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteQuoteQualifier item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteQuoteQualifier Last
		{
			get { return _last; }
		}
	}

	public class QuotePartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private QuotePartySubIDList _listPartySubID = new QuotePartySubIDList();
		...
		public QuotePartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_PartyID:
						return _sPartyID;
					case Quote.TAG_PartyIDSource:
						return _cPartyIDSource;
					case Quote.TAG_PartyRole:
						return _iPartyRole;
					case Quote.TAG_NoPartySubIDs:
	...
	public class QuotePartyIDList
	{
		private ArrayList _al;
		private QuotePartyID _last;

		public QuotePartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuotePartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuotePartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuotePartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuotePartyID Last
		{
			get { return _last; }
		}
	}

	public class QuotePartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_PartySubID:
						return _sPartySubID;
					case Quote.TAG_PartySubIDType:
	...
	public class QuotePartySubIDList
	{
		private ArrayList _al;
		private QuotePartySubID _last;

		public QuotePartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuotePartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuotePartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuotePartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuotePartySubID Last
		{
			get { return _last; }
		}
	}

	public class QuoteSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_SecurityAltID:
						return _sSecurityAltID;
					case Quote.TAG_SecurityAltIDSource:
	...
	public class QuoteSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteSecurityAltID _last;

		public QuoteSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteSecurityAltID Last
		{
			get { return _last; }
		}
	}
	...
	public class QuoteEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_EventType:
						return _iEventType;
					case Quote.TAG_EventDate:
						return _dtEventDate;
					case Quote.TAG_EventPx:
						return _dEventPx;
					case Quote.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	{
		private ArrayList _al;
		private QuoteEvent _last;

		public QuoteEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteEvent Last
		{
			get { return _last; }
		}
	}

	public class QuoteUnderlying
	{
		...
		private QuoteUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new QuoteUnderlyingSecurityAltIDList();
		...
		public QuoteUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case Quote.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case Quote.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case Quote.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case Quote.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case Quote.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case Quote.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case Quote.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case Quote.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case Quote.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case Quote.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case Quote.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case Quote.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case Quote.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case Quote.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case Quote.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case Quote.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case Quote.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case Quote.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case Quote.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case Quote.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case Quote.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case Quote.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case Quote.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case Quote.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case Quote.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case Quote.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case Quote.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case Quote.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case Quote.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case Quote.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case Quote.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case Quote.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case Quote.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case Quote.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case Quote.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case Quote.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case Quote.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case Quote.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case Quote.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case Quote.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case Quote.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case Quote.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case Quote.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case Quote.TAG_UnderlyingEndValue:
	...
	public class QuoteUnderlyingList
	{
		private ArrayList _al;
		private QuoteUnderlying _last;

		public QuoteUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteUnderlying Last
		{
			get { return _last; }
		}
	}

	public class QuoteUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case Quote.TAG_UnderlyingSecurityAltIDSource:
	...
	public class QuoteUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteUnderlyingSecurityAltID _last;

		public QuoteUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_StipulationType:
						return _sStipulationType;
					case Quote.TAG_StipulationValue:
	...
	public class QuoteStipulationList
	{
		private ArrayList _al;
		private QuoteStipulation _last;

		public QuoteStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
	...
	public class QuoteLeg
	{
		...
		private QuoteLegSecurityAltIDList _listLegSecurityAltID = new QuoteLegSecurityAltIDList();
		...
		private QuoteLegStipulationList _listLegStipulation = new QuoteLegStipulationList();
		private int _iNoNestedPartyIDs;
		private QuoteNestedPartyIDList _listNestedPartyID = new QuoteNestedPartyIDList();
		...
		public QuoteLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public QuoteLegStipulationList LegStipulation 
		{
		...
		public QuoteNestedPartyIDList NestedPartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_LegSymbol:
						return _sLegSymbol;
					case Quote.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case Quote.TAG_LegSecurityID:
						return _sLegSecurityID;
					case Quote.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case Quote.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case Quote.TAG_LegProduct:
						return _iLegProduct;
					case Quote.TAG_LegCFICode:
						return _sLegCFICode;
					case Quote.TAG_LegSecurityType:
						return _sLegSecurityType;
					case Quote.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case Quote.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case Quote.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case Quote.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case Quote.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case Quote.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case Quote.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case Quote.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case Quote.TAG_LegFactor:
						return _dLegFactor;
					case Quote.TAG_LegCreditRating:
						return _sLegCreditRating;
					case Quote.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case Quote.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case Quote.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case Quote.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case Quote.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case Quote.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case Quote.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case Quote.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case Quote.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case Quote.TAG_LegCouponRate:
						return _dLegCouponRate;
					case Quote.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case Quote.TAG_LegIssuer:
						return _sLegIssuer;
					case Quote.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case Quote.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case Quote.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case Quote.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case Quote.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case Quote.TAG_LegRatioQty:
						return _dLegRatioQty;
					case Quote.TAG_LegSide:
						return _cLegSide;
					case Quote.TAG_LegCurrency:
						return _sLegCurrency;
					case Quote.TAG_LegPool:
						return _sLegPool;
					case Quote.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case Quote.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case Quote.TAG_LegInterestAccrualDate:
						return _dtLegInterestAccrualDate;
					case Quote.TAG_LegQty:
						return _iLegQty;
					case Quote.TAG_LegSwapType:
						return _iLegSwapType;
					case Quote.TAG_LegSettlType:
						return _cLegSettlType;
					case Quote.TAG_LegSettlDate:
						return _dtLegSettlDate;
					case Quote.TAG_NoLegStipulations:
						return _iNoLegStipulations;
					case Quote.TAG_NoNestedPartyIDs:
						return _iNoNestedPartyIDs;
					case Quote.TAG_LegPriceType:
						return _iLegPriceType;
					case Quote.TAG_LegBidPx:
						return _dLegBidPx;
					case Quote.TAG_LegOfferPx:
						return _dLegOfferPx;
					case Quote.TAG_LegBenchmarkCurveCurrency:
						return _sLegBenchmarkCurveCurrency;
					case Quote.TAG_LegBenchmarkCurveName:
						return _sLegBenchmarkCurveName;
					case Quote.TAG_LegBenchmarkCurvePoint:
						return _sLegBenchmarkCurvePoint;
					case Quote.TAG_LegBenchmarkPrice:
						return _dLegBenchmarkPrice;
					case Quote.TAG_LegBenchmarkPriceType:
	...
	public class QuoteLegList
	{
		private ArrayList _al;
		private QuoteLeg _last;

		public QuoteLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Remove(QuoteLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteLeg Last
		{
			get { return _last; }
		}
	}

	public class QuoteLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case Quote.TAG_LegSecurityAltIDSource:
	...
	public class QuoteLegSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteLegSecurityAltID _last;

		public QuoteLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteLegStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_LegStipulationType:
						return _sLegStipulationType;
					case Quote.TAG_LegStipulationValue:
	...
	public class QuoteLegStipulationList
	{
		private ArrayList _al;
		private QuoteLegStipulation _last;

		public QuoteLegStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteLegStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteLegStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteLegStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteLegStipulation Last
		{
			get { return _last; }
		}
	}

	public class QuoteNestedPartyID
	{
		...
		private QuoteNestedPartySubIDList _listNestedPartySubID = new QuoteNestedPartySubIDList();
		...
		public QuoteNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_NestedPartyID:
						return _sNestedPartyID;
					case Quote.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case Quote.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case Quote.TAG_NoNestedPartySubIDs:
	...
	public class QuoteNestedPartyIDList
	{
		private ArrayList _al;
		private QuoteNestedPartyID _last;

		public QuoteNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Quote.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case Quote.TAG_NestedPartySubIDType:
	...
	public class QuoteNestedPartySubIDList
	{
		private ArrayList _al;
		private QuoteNestedPartySubID _last;

		public QuoteNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteNestedPartySubID Last
		{
			get { return _last; }
		}
	}
