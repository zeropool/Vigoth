...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class QuoteResponse : Message
	{
		...
		public const int TAG_LegPriceType = 686;
		public const int TAG_LegBidPx = 681;
		public const int TAG_LegOfferPx = 684;
		...
		private QuoteResponseQuoteQualifierList _listQuoteQualifier = new QuoteResponseQuoteQualifierList();
		private int _iNoPartyIDs;
		private QuoteResponsePartyIDList _listPartyID = new QuoteResponsePartyIDList();
		...
		private QuoteResponseSecurityAltIDList _listSecurityAltID = new QuoteResponseSecurityAltIDList();
		...
		private QuoteResponseEventList _listEvent = new QuoteResponseEventList();
		...
		private QuoteResponseUnderlyingList _listUnderlying = new QuoteResponseUnderlyingList();
		private char _cSide;
		...
		private QuoteResponseStipulationList _listStipulation = new QuoteResponseStipulationList();
		private string _sAccount;
		private int _iAcctIDSource;
		private int _iAccountType;
		private int _iNoLegs;
		private QuoteResponseLegList _listLeg = new QuoteResponseLegList();
		...
		{
			_sMsgType = Values.MsgType.QuoteResponse;
		}
		...
		{
			get { return _iQuoteRespType; }
			set { _iQuoteRespType = value; }
		}
		...
		public QuoteResponseQuoteQualifierList QuoteQualifier 
		{
		...
		public QuoteResponsePartyIDList PartyID 
		{
		...
		public QuoteResponseSecurityAltIDList SecurityAltID 
		{
		...
		public QuoteResponseEventList Event 
		{
		...
		public QuoteResponseUnderlyingList Underlying 
		{
		...
		public QuoteResponseStipulationList Stipulation 
		{
		...
		public QuoteResponseLegList Leg 
		{
			get { return _listLeg; }
		}
		public double BidPx
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_QuoteID:
						return _sQuoteID;
					case TAG_QuoteRespType:
						return _iQuoteRespType;
					case TAG_ClOrdID:
						return _sClOrdID;
	...
	public class QuoteResponseQuoteQualifier
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_QuoteQualifier:
	...
	public class QuoteResponseQuoteQualifierList
	{
		private ArrayList _al;
		private QuoteResponseQuoteQualifier _last;

		public QuoteResponseQuoteQualifier this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseQuoteQualifier)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseQuoteQualifier item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseQuoteQualifier item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseQuoteQualifier Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponsePartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private QuoteResponsePartySubIDList _listPartySubID = new QuoteResponsePartySubIDList();
		...
		public QuoteResponsePartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_PartyID:
						return _sPartyID;
					case QuoteResponse.TAG_PartyIDSource:
						return _cPartyIDSource;
					case QuoteResponse.TAG_PartyRole:
						return _iPartyRole;
					case QuoteResponse.TAG_NoPartySubIDs:
	...
	public class QuoteResponsePartyIDList
	{
		private ArrayList _al;
		private QuoteResponsePartyID _last;

		public QuoteResponsePartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponsePartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponsePartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponsePartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponsePartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponsePartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_PartySubID:
						return _sPartySubID;
					case QuoteResponse.TAG_PartySubIDType:
	...
	public class QuoteResponsePartySubIDList
	{
		private ArrayList _al;
		private QuoteResponsePartySubID _last;

		public QuoteResponsePartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponsePartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponsePartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponsePartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponsePartySubID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_SecurityAltID:
						return _sSecurityAltID;
					case QuoteResponse.TAG_SecurityAltIDSource:
	...
	public class QuoteResponseSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteResponseSecurityAltID _last;

		public QuoteResponseSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_EventType:
						return _iEventType;
					case QuoteResponse.TAG_EventDate:
						return _dtEventDate;
					case QuoteResponse.TAG_EventPx:
						return _dEventPx;
					case QuoteResponse.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class QuoteResponseEventList
	{
		private ArrayList _al;
		private QuoteResponseEvent _last;

		public QuoteResponseEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseEvent Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseUnderlying
	{
		...
		private QuoteResponseUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new QuoteResponseUnderlyingSecurityAltIDList();
		...
		public QuoteResponseUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case QuoteResponse.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case QuoteResponse.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case QuoteResponse.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case QuoteResponse.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case QuoteResponse.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case QuoteResponse.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case QuoteResponse.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case QuoteResponse.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case QuoteResponse.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case QuoteResponse.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case QuoteResponse.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case QuoteResponse.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case QuoteResponse.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case QuoteResponse.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case QuoteResponse.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case QuoteResponse.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case QuoteResponse.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case QuoteResponse.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case QuoteResponse.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case QuoteResponse.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case QuoteResponse.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case QuoteResponse.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case QuoteResponse.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case QuoteResponse.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case QuoteResponse.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case QuoteResponse.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case QuoteResponse.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case QuoteResponse.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case QuoteResponse.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case QuoteResponse.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case QuoteResponse.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case QuoteResponse.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case QuoteResponse.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case QuoteResponse.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case QuoteResponse.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case QuoteResponse.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case QuoteResponse.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case QuoteResponse.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case QuoteResponse.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case QuoteResponse.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case QuoteResponse.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case QuoteResponse.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case QuoteResponse.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case QuoteResponse.TAG_UnderlyingEndValue:
	...
	public class QuoteResponseUnderlyingList
	{
		private ArrayList _al;
		private QuoteResponseUnderlying _last;

		public QuoteResponseUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseUnderlying Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case QuoteResponse.TAG_UnderlyingSecurityAltIDSource:
	...
	public class QuoteResponseUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteResponseUnderlyingSecurityAltID _last;

		public QuoteResponseUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_StipulationType:
						return _sStipulationType;
					case QuoteResponse.TAG_StipulationValue:
	...
	public class QuoteResponseStipulationList
	{
		private ArrayList _al;
		private QuoteResponseStipulation _last;

		public QuoteResponseStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseStipulation Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseLeg
	{
		...
		private QuoteResponseLegSecurityAltIDList _listLegSecurityAltID = new QuoteResponseLegSecurityAltIDList();
		...
		private QuoteResponseLegStipulationList _listLegStipulation = new QuoteResponseLegStipulationList();
		private int _iNoNestedPartyIDs;
		private QuoteResponseNestedPartyIDList _listNestedPartyID = new QuoteResponseNestedPartyIDList();
		private int _iLegPriceType;
		private double _dLegBidPx;
		private double _dLegOfferPx;
		...
		public QuoteResponseLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public QuoteResponseLegStipulationList LegStipulation 
		{
		...
		public QuoteResponseNestedPartyIDList NestedPartyID 
		{
			get { return _listNestedPartyID; }
		}
		public int LegPriceType
		{
			get { return _iLegPriceType; }
			set { _iLegPriceType = value; }
		}
		public double LegBidPx
		{
			get { return _dLegBidPx; }
			set { _dLegBidPx = value; }
		}
		public double LegOfferPx
		{
			get { return _dLegOfferPx; }
			set { _dLegOfferPx = value; }
		}
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_LegSymbol:
						return _sLegSymbol;
					case QuoteResponse.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case QuoteResponse.TAG_LegSecurityID:
						return _sLegSecurityID;
					case QuoteResponse.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case QuoteResponse.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case QuoteResponse.TAG_LegProduct:
						return _iLegProduct;
					case QuoteResponse.TAG_LegCFICode:
						return _sLegCFICode;
					case QuoteResponse.TAG_LegSecurityType:
						return _sLegSecurityType;
					case QuoteResponse.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case QuoteResponse.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case QuoteResponse.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case QuoteResponse.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case QuoteResponse.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case QuoteResponse.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case QuoteResponse.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case QuoteResponse.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case QuoteResponse.TAG_LegFactor:
						return _dLegFactor;
					case QuoteResponse.TAG_LegCreditRating:
						return _sLegCreditRating;
					case QuoteResponse.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case QuoteResponse.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case QuoteResponse.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case QuoteResponse.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case QuoteResponse.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case QuoteResponse.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case QuoteResponse.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case QuoteResponse.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case QuoteResponse.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case QuoteResponse.TAG_LegCouponRate:
						return _dLegCouponRate;
					case QuoteResponse.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case QuoteResponse.TAG_LegIssuer:
						return _sLegIssuer;
					case QuoteResponse.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case QuoteResponse.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case QuoteResponse.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case QuoteResponse.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case QuoteResponse.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case QuoteResponse.TAG_LegRatioQty:
						return _dLegRatioQty;
					case QuoteResponse.TAG_LegSide:
						return _cLegSide;
					case QuoteResponse.TAG_LegCurrency:
						return _sLegCurrency;
					case QuoteResponse.TAG_LegPool:
						return _sLegPool;
					case QuoteResponse.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case QuoteResponse.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case QuoteResponse.TAG_LegInterestAccrualDate:
						return _dtLegInterestAccrualDate;
					case QuoteResponse.TAG_LegQty:
						return _iLegQty;
					case QuoteResponse.TAG_LegSwapType:
						return _iLegSwapType;
					case QuoteResponse.TAG_LegSettlType:
						return _cLegSettlType;
					case QuoteResponse.TAG_LegSettlDate:
						return _dtLegSettlDate;
					case QuoteResponse.TAG_NoLegStipulations:
						return _iNoLegStipulations;
					case QuoteResponse.TAG_NoNestedPartyIDs:
						return _iNoNestedPartyIDs;
					case QuoteResponse.TAG_LegPriceType:
						return _iLegPriceType;
					case QuoteResponse.TAG_LegBidPx:
						return _dLegBidPx;
					case QuoteResponse.TAG_LegOfferPx:
						return _dLegOfferPx;
					case QuoteResponse.TAG_LegBenchmarkCurveCurrency:
						return _sLegBenchmarkCurveCurrency;
					case QuoteResponse.TAG_LegBenchmarkCurveName:
						return _sLegBenchmarkCurveName;
					case QuoteResponse.TAG_LegBenchmarkCurvePoint:
						return _sLegBenchmarkCurvePoint;
					case QuoteResponse.TAG_LegBenchmarkPrice:
						return _dLegBenchmarkPrice;
					case QuoteResponse.TAG_LegBenchmarkPriceType:
			...
			set
			{
				switch (iTag)
				{
					...
					case QuoteResponse.TAG_NoNestedPartyIDs:
						...
						break;
					case QuoteResponse.TAG_LegPriceType:
						_iLegPriceType = (int)value;
						break;
					case QuoteResponse.TAG_LegBidPx:
						_dLegBidPx = (double)value;
						break;
					case QuoteResponse.TAG_LegOfferPx:
						_dLegOfferPx = (double)value;
						break;
					case QuoteResponse.TAG_LegBenchmarkCurveCurrency:
	...
	public class QuoteResponseLegList
	{
		private ArrayList _al;
		private QuoteResponseLeg _last;

		public QuoteResponseLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseLeg Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case QuoteResponse.TAG_LegSecurityAltIDSource:
	...
	public class QuoteResponseLegSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteResponseLegSecurityAltID _last;

		public QuoteResponseLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseLegStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_LegStipulationType:
						return _sLegStipulationType;
					case QuoteResponse.TAG_LegStipulationValue:
	...
	public class QuoteResponseLegStipulationList
	{
		private ArrayList _al;
		private QuoteResponseLegStipulation _last;

		public QuoteResponseLegStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseLegStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseLegStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseLegStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseLegStipulation Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseNestedPartyID
	{
		...
		private QuoteResponseNestedPartySubIDList _listNestedPartySubID = new QuoteResponseNestedPartySubIDList();
		...
		public QuoteResponseNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_NestedPartyID:
						return _sNestedPartyID;
					case QuoteResponse.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case QuoteResponse.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case QuoteResponse.TAG_NoNestedPartySubIDs:
	...
	public class QuoteResponseNestedPartyIDList
	{
		private ArrayList _al;
		private QuoteResponseNestedPartyID _last;

		public QuoteResponseNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteResponseNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteResponse.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case QuoteResponse.TAG_NestedPartySubIDType:
	...
	public class QuoteResponseNestedPartySubIDList
	{
		private ArrayList _al;
		private QuoteResponseNestedPartySubID _last;

		public QuoteResponseNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteResponseNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteResponseNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteResponseNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteResponseNestedPartySubID Last
		{
			get { return _last; }
		}
	}
