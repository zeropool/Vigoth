...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class CollateralRequest : Message
	{
		...
		private CollateralRequestPartyIDList _listPartyID = new CollateralRequestPartyIDList();
		...
		private CollateralRequestExecList _listExec = new CollateralRequestExecList();
		private int _iNoTrades;
		private CollateralRequestTradeList _listTrade = new CollateralRequestTradeList();
		...
		private CollateralRequestSecurityAltIDList _listSecurityAltID = new CollateralRequestSecurityAltIDList();
		...
		private CollateralRequestEventList _listEvent = new CollateralRequestEventList();
		...
		private CollateralRequestLegSecurityAltIDList _listLegSecurityAltID = new CollateralRequestLegSecurityAltIDList();
		...
		private CollateralRequestUnderlyingList _listUnderlying = new CollateralRequestUnderlyingList();
		...
		private CollateralRequestTrdRegTimestampList _listTrdRegTimestamp = new CollateralRequestTrdRegTimestampList();
		private char _cSide;
		private int _iNoMiscFees;
		private CollateralRequestMiscFeeList _listMiscFee = new CollateralRequestMiscFeeList();
		...
		private CollateralRequestStipulationList _listStipulation = new CollateralRequestStipulationList();
		...
		{
			_sMsgType = Values.MsgType.CollateralRequest;
		}
		...
		public CollateralRequestPartyIDList PartyID 
		{
		...
		public CollateralRequestExecList Exec 
		{
		...
		public CollateralRequestTradeList Trade 
		{
		...
		public CollateralRequestSecurityAltIDList SecurityAltID 
		{
		...
		public CollateralRequestEventList Event 
		{
		...
		public CollateralRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public CollateralRequestUnderlyingList Underlying 
		{
		...
		public CollateralRequestTrdRegTimestampList TrdRegTimestamp 
		{
		...
		public CollateralRequestMiscFeeList MiscFee 
		{
		...
		public CollateralRequestStipulationList Stipulation 
		{
	...
	public class CollateralRequestPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private CollateralRequestPartySubIDList _listPartySubID = new CollateralRequestPartySubIDList();
		...
		public CollateralRequestPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_PartyID:
						return _sPartyID;
					case CollateralRequest.TAG_PartyIDSource:
						return _cPartyIDSource;
					case CollateralRequest.TAG_PartyRole:
						return _iPartyRole;
					case CollateralRequest.TAG_NoPartySubIDs:
	...
	public class CollateralRequestPartyIDList
	{
		private ArrayList _al;
		private CollateralRequestPartyID _last;

		public CollateralRequestPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestPartyID Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_PartySubID:
						return _sPartySubID;
					case CollateralRequest.TAG_PartySubIDType:
	...
	public class CollateralRequestPartySubIDList
	{
		private ArrayList _al;
		private CollateralRequestPartySubID _last;

		public CollateralRequestPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestPartySubID Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestExec
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_ExecID:
						return _sExecID;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class CollateralRequestExecList
	{
		private ArrayList _al;
		private CollateralRequestExec _last;

		public CollateralRequestExec this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestExec)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestExec item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestExec item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestExec Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestTrade
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_TradeReportID:
						return _sTradeReportID;
					case CollateralRequest.TAG_SecondaryTradeReportID:
	...
	public class CollateralRequestTradeList
	{
		private ArrayList _al;
		private CollateralRequestTrade _last;

		public CollateralRequestTrade this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestTrade)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestTrade item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestTrade item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestTrade Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case CollateralRequest.TAG_SecurityAltIDSource:
	...
	public class CollateralRequestSecurityAltIDList
	{
		private ArrayList _al;
		private CollateralRequestSecurityAltID _last;

		public CollateralRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_EventType:
						return _iEventType;
					case CollateralRequest.TAG_EventDate:
						return _dtEventDate;
					case CollateralRequest.TAG_EventPx:
						return _dEventPx;
					case CollateralRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class CollateralRequestEventList
	{
		private ArrayList _al;
		private CollateralRequestEvent _last;

		public CollateralRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case CollateralRequest.TAG_LegSecurityAltIDSource:
	...
	public class CollateralRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private CollateralRequestLegSecurityAltID _last;

		public CollateralRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestUnderlying
	{
		...
		private CollateralRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new CollateralRequestUnderlyingSecurityAltIDList();
		...
		public CollateralRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case CollateralRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case CollateralRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case CollateralRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case CollateralRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case CollateralRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case CollateralRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case CollateralRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case CollateralRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case CollateralRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case CollateralRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case CollateralRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case CollateralRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case CollateralRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case CollateralRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case CollateralRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case CollateralRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case CollateralRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case CollateralRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case CollateralRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case CollateralRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case CollateralRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case CollateralRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case CollateralRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case CollateralRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case CollateralRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case CollateralRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case CollateralRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case CollateralRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case CollateralRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case CollateralRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case CollateralRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case CollateralRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case CollateralRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case CollateralRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case CollateralRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case CollateralRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case CollateralRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case CollateralRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case CollateralRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case CollateralRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case CollateralRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case CollateralRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case CollateralRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case CollateralRequest.TAG_UnderlyingEndValue:
						return _dUnderlyingEndValue;
					case CollateralRequest.TAG_CollAction:
						return _iCollAction;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class CollateralRequestUnderlyingList
	{
		private ArrayList _al;
		private CollateralRequestUnderlying _last;

		public CollateralRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case CollateralRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class CollateralRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private CollateralRequestUnderlyingSecurityAltID _last;

		public CollateralRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestTrdRegTimestamp
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_TrdRegTimestamp:
						return _dtTrdRegTimestamp;
					case CollateralRequest.TAG_TrdRegTimestampType:
						return _iTrdRegTimestampType;
					case CollateralRequest.TAG_TrdRegTimestampOrigin:
	...
	public class CollateralRequestTrdRegTimestampList
	{
		private ArrayList _al;
		private CollateralRequestTrdRegTimestamp _last;

		public CollateralRequestTrdRegTimestamp this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestTrdRegTimestamp)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestTrdRegTimestamp item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestTrdRegTimestamp item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestTrdRegTimestamp Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestMiscFee
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_MiscFeeAmt:
						return _dMiscFeeAmt;
					case CollateralRequest.TAG_MiscFeeCurr:
						return _sMiscFeeCurr;
					case CollateralRequest.TAG_MiscFeeType:
						return _cMiscFeeType;
					case CollateralRequest.TAG_MiscFeeBasis:
	...
	public class CollateralRequestMiscFeeList
	{
		private ArrayList _al;
		private CollateralRequestMiscFee _last;

		public CollateralRequestMiscFee this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestMiscFee)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestMiscFee item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestMiscFee item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestMiscFee Last
		{
			get { return _last; }
		}
	}

	public class CollateralRequestStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case CollateralRequest.TAG_StipulationType:
						return _sStipulationType;
					case CollateralRequest.TAG_StipulationValue:
	...
	public class CollateralRequestStipulationList
	{
		private ArrayList _al;
		private CollateralRequestStipulation _last;

		public CollateralRequestStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (CollateralRequestStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(CollateralRequestStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(CollateralRequestStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public CollateralRequestStipulation Last
		{
			get { return _last; }
		}
	}
