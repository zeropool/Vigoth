...
{
	/// <summary>
	/// Summary description for TradeCaptureReportRequest.
	/// </summary>
	public class TradeCaptureReportRequest : Message
	{
		...
		public const int TAG_NoDates = 580;
		...
		private TradeCaptureReportRequestPartyIDList _listPartyID = new TradeCaptureReportRequestPartyIDList();
		...
		private TradeCaptureReportRequestSecurityAltIDList _listSecurityAltID = new TradeCaptureReportRequestSecurityAltIDList();
		...
		private TradeCaptureReportRequestEventList _listEvent = new TradeCaptureReportRequestEventList();
		...
		private TradeCaptureReportRequestInstrAttribList _listInstrAttrib = new TradeCaptureReportRequestInstrAttribList();
		...
		private TradeCaptureReportRequestUnderlyingList _listUnderlying = new TradeCaptureReportRequestUnderlyingList();
		private int _iNoLegs;
		private TradeCaptureReportRequestLegList _listLeg = new TradeCaptureReportRequestLegList();
		private int _iNoDates;
		private TradeCaptureReportRequestDateList _listDate = new TradeCaptureReportRequestDateList();
		...
		{
			_sMsgType = Values.MsgType.TradeCaptureReportRequest;
		}
		...
		public TradeCaptureReportRequestPartyIDList PartyID 
		{
		...
		public TradeCaptureReportRequestSecurityAltIDList SecurityAltID 
		{
		...
		public TradeCaptureReportRequestEventList Event 
		{
		...
		public TradeCaptureReportRequestInstrAttribList InstrAttrib 
		{
		...
		public TradeCaptureReportRequestUnderlyingList Underlying 
		{
		...
		public TradeCaptureReportRequestLegList Leg 
		{
			get { return _listLeg; }
		}
		public int NoDates
		{
			get { return _iNoDates; }
			set { _iNoDates = value; }
		}
		public TradeCaptureReportRequestDateList Date 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_TradeInputSource:
						return _sTradeInputSource;
					case TAG_TradeInputDevice:
	...
	public class TradeCaptureReportRequestPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private TradeCaptureReportRequestPartySubIDList _listPartySubID = new TradeCaptureReportRequestPartySubIDList();
		...
		public TradeCaptureReportRequestPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_PartyID:
						return _sPartyID;
					case TradeCaptureReportRequest.TAG_PartyIDSource:
						return _cPartyIDSource;
					case TradeCaptureReportRequest.TAG_PartyRole:
						return _iPartyRole;
					case TradeCaptureReportRequest.TAG_NoPartySubIDs:
	...
	public class TradeCaptureReportRequestPartyIDList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestPartyID _last;

		public TradeCaptureReportRequestPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestPartyID Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_PartySubID:
						return _sPartySubID;
					case TradeCaptureReportRequest.TAG_PartySubIDType:
	...
	public class TradeCaptureReportRequestPartySubIDList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestPartySubID _last;

		public TradeCaptureReportRequestPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestPartySubID Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case TradeCaptureReportRequest.TAG_SecurityAltIDSource:
	...
	public class TradeCaptureReportRequestSecurityAltIDList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestSecurityAltID _last;

		public TradeCaptureReportRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_EventType:
						return _iEventType;
					case TradeCaptureReportRequest.TAG_EventDate:
						return _dtEventDate;
					case TradeCaptureReportRequest.TAG_EventPx:
						return _dEventPx;
					case TradeCaptureReportRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class TradeCaptureReportRequestEventList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestEvent _last;

		public TradeCaptureReportRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_InstrAttribType:
						return _iInstrAttribType;
					case TradeCaptureReportRequest.TAG_InstrAttribValue:
	...
	public class TradeCaptureReportRequestInstrAttribList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestInstrAttrib _last;

		public TradeCaptureReportRequestInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestUnderlying
	{
		...
		private TradeCaptureReportRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new TradeCaptureReportRequestUnderlyingSecurityAltIDList();
		...
		public TradeCaptureReportRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case TradeCaptureReportRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case TradeCaptureReportRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case TradeCaptureReportRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case TradeCaptureReportRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case TradeCaptureReportRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case TradeCaptureReportRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case TradeCaptureReportRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case TradeCaptureReportRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case TradeCaptureReportRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case TradeCaptureReportRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case TradeCaptureReportRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case TradeCaptureReportRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case TradeCaptureReportRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case TradeCaptureReportRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case TradeCaptureReportRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case TradeCaptureReportRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case TradeCaptureReportRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case TradeCaptureReportRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case TradeCaptureReportRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case TradeCaptureReportRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case TradeCaptureReportRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case TradeCaptureReportRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case TradeCaptureReportRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case TradeCaptureReportRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case TradeCaptureReportRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case TradeCaptureReportRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case TradeCaptureReportRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case TradeCaptureReportRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case TradeCaptureReportRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case TradeCaptureReportRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case TradeCaptureReportRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case TradeCaptureReportRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case TradeCaptureReportRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case TradeCaptureReportRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case TradeCaptureReportRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case TradeCaptureReportRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case TradeCaptureReportRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case TradeCaptureReportRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case TradeCaptureReportRequest.TAG_UnderlyingEndValue:
	...
	public class TradeCaptureReportRequestUnderlyingList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestUnderlying _last;

		public TradeCaptureReportRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case TradeCaptureReportRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class TradeCaptureReportRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestUnderlyingSecurityAltID _last;

		public TradeCaptureReportRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestLeg
	{
		...
		private TradeCaptureReportRequestLegSecurityAltIDList _listLegSecurityAltID = new TradeCaptureReportRequestLegSecurityAltIDList();
		...
		public TradeCaptureReportRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_LegSymbol:
						return _sLegSymbol;
					case TradeCaptureReportRequest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case TradeCaptureReportRequest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case TradeCaptureReportRequest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case TradeCaptureReportRequest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case TradeCaptureReportRequest.TAG_LegProduct:
						return _iLegProduct;
					case TradeCaptureReportRequest.TAG_LegCFICode:
						return _sLegCFICode;
					case TradeCaptureReportRequest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case TradeCaptureReportRequest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case TradeCaptureReportRequest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case TradeCaptureReportRequest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case TradeCaptureReportRequest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case TradeCaptureReportRequest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case TradeCaptureReportRequest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case TradeCaptureReportRequest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case TradeCaptureReportRequest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case TradeCaptureReportRequest.TAG_LegFactor:
						return _dLegFactor;
					case TradeCaptureReportRequest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case TradeCaptureReportRequest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case TradeCaptureReportRequest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case TradeCaptureReportRequest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case TradeCaptureReportRequest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case TradeCaptureReportRequest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case TradeCaptureReportRequest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case TradeCaptureReportRequest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case TradeCaptureReportRequest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case TradeCaptureReportRequest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case TradeCaptureReportRequest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case TradeCaptureReportRequest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case TradeCaptureReportRequest.TAG_LegIssuer:
						return _sLegIssuer;
					case TradeCaptureReportRequest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case TradeCaptureReportRequest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case TradeCaptureReportRequest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case TradeCaptureReportRequest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case TradeCaptureReportRequest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case TradeCaptureReportRequest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case TradeCaptureReportRequest.TAG_LegSide:
						return _cLegSide;
					case TradeCaptureReportRequest.TAG_LegCurrency:
						return _sLegCurrency;
					case TradeCaptureReportRequest.TAG_LegPool:
						return _sLegPool;
					case TradeCaptureReportRequest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case TradeCaptureReportRequest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case TradeCaptureReportRequest.TAG_LegInterestAccrualDate:
	...
	public class TradeCaptureReportRequestLegList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestLeg _last;

		public TradeCaptureReportRequestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestLeg Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case TradeCaptureReportRequest.TAG_LegSecurityAltIDSource:
	...
	public class TradeCaptureReportRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestLegSecurityAltID _last;

		public TradeCaptureReportRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class TradeCaptureReportRequestDate
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TradeCaptureReportRequest.TAG_TradeDate:
						return _dtTradeDate;
					case TradeCaptureReportRequest.TAG_TransactTime:
	...
	public class TradeCaptureReportRequestDateList
	{
		private ArrayList _al;
		private TradeCaptureReportRequestDate _last;

		public TradeCaptureReportRequestDate this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (TradeCaptureReportRequestDate)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(TradeCaptureReportRequestDate item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(TradeCaptureReportRequestDate item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public TradeCaptureReportRequestDate Last
		{
			get { return _last; }
		}
	}
