...
{
	/// <summary>
	/// Summary description for SecurityStatus.
	/// </summary>
	public class SecurityStatus : Message
	{
		...
		public const int TAG_HaltReason = 327;
		public const int TAG_InViewOfCommon = 328;
		public const int TAG_DueToRelated = 329;
		public const int TAG_BuyVolume = 330;
		public const int TAG_SellVolume = 331;
		...
		public const int TAG_Adjustment = 334;
		...
		private SecurityStatusSecurityAltIDList _listSecurityAltID = new SecurityStatusSecurityAltIDList();
		...
		private SecurityStatusEventList _listEvent = new SecurityStatusEventList();
		...
		private SecurityStatusInstrAttribList _listInstrAttrib = new SecurityStatusInstrAttribList();
		private int _iNoUnderlyings;
		private SecurityStatusUnderlyingList _listUnderlying = new SecurityStatusUnderlyingList();
		private int _iNoLegs;
		private SecurityStatusLegList _listLeg = new SecurityStatusLegList();
		private string _sCurrency;
		private string _sTradingSessionID;
		private string _sTradingSessionSubID;
		private bool _bUnsolicitedIndicator;
		private int _iSecurityTradingStatus;
		private string _sFinancialStatus;
		private string _sCorporateAction;
		private char _cHaltReason;
		private bool _bInViewOfCommon;
		private bool _bDueToRelated;
		private int _iBuyVolume;
		private int _iSellVolume;
		private double _dHighPx;
		private double _dLowPx;
		private double _dLastPx;
		private DateTime _dtTransactTime;
		private int _iAdjustment;
		...
		{
			_sMsgType = Values.MsgType.SecurityStatus;
		}
		...
		public SecurityStatusSecurityAltIDList SecurityAltID 
		{
		...
		public SecurityStatusEventList Event 
		{
		...
		public SecurityStatusInstrAttribList InstrAttrib 
		{
		...
		public SecurityStatusUnderlyingList Underlying 
		{
		...
		public SecurityStatusLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		{
			get { return _iSecurityTradingStatus; }
			set { _iSecurityTradingStatus = value; }
		}
		...
		{
			get { return _cHaltReason; }
			set { _cHaltReason = value; }
		}
		public bool InViewOfCommon
		{
			get { return _bInViewOfCommon; }
			set { _bInViewOfCommon = value; }
		}
		public bool DueToRelated
		{
			get { return _bDueToRelated; }
			set { _bDueToRelated = value; }
		}
		public int BuyVolume
		{
			get { return _iBuyVolume; }
			set { _iBuyVolume = value; }
		}
		public int SellVolume
		{
			get { return _iSellVolume; }
			set { _iSellVolume = value; }
		}
		...
		{
			get { return _iAdjustment; }
			set { _iAdjustment = value; }
		}
		public string Text
		{
			get { return _sText; }
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_SecurityTradingStatus:
						return _iSecurityTradingStatus;
					...
					case TAG_HaltReason:
						return _cHaltReason;
					case TAG_InViewOfCommon:
						return _bInViewOfCommon;
					case TAG_DueToRelated:
						return _bDueToRelated;
					case TAG_BuyVolume:
						return _iBuyVolume;
					case TAG_SellVolume:
						return _iSellVolume;
			...
			set
			{
				switch (iTag)
				{
					...
					case TAG_UnsolicitedIndicator:
						...
						break;
					case TAG_SecurityTradingStatus:
						_iSecurityTradingStatus = (int)value;
						break;
					case TAG_FinancialStatus:
					...
					case TAG_CorporateAction:
						...
						break;
					case TAG_HaltReason:
						_cHaltReason = (char)value;
						break;
					case TAG_InViewOfCommon:
						_bInViewOfCommon = (bool)value;
						break;
					case TAG_DueToRelated:
						_bDueToRelated = (bool)value;
						break;
					case TAG_BuyVolume:
						_iBuyVolume = (int)value;
						break;
					case TAG_SellVolume:
						_iSellVolume = (int)value;
						break;
					case TAG_HighPx:
						_dHighPx = (double)value;
						break;
					case TAG_LowPx:
						_dLowPx = (double)value;
						break;
					case TAG_LastPx:
	...
	public class SecurityStatusSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_SecurityAltID:
						return _sSecurityAltID;
					case SecurityStatus.TAG_SecurityAltIDSource:
	...
	public class SecurityStatusSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusSecurityAltID _last;

		public SecurityStatusSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusSecurityAltID Last
		{
			get { return _last; }
		}
	}
	...
	public class SecurityStatusEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_EventType:
						return _iEventType;
					case SecurityStatus.TAG_EventDate:
						return _dtEventDate;
					case SecurityStatus.TAG_EventPx:
						return _dEventPx;
					case SecurityStatus.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class SecurityStatusEventList
	{
		private ArrayList _al;
		private SecurityStatusEvent _last;

		public SecurityStatusEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusEvent Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_InstrAttribType:
						return _iInstrAttribType;
					case SecurityStatus.TAG_InstrAttribValue:
	...
	public class SecurityStatusInstrAttribList
	{
		private ArrayList _al;
		private SecurityStatusInstrAttrib _last;

		public SecurityStatusInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusUnderlying
	{
		...
		private SecurityStatusUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new SecurityStatusUnderlyingSecurityAltIDList();
		...
		public SecurityStatusUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case SecurityStatus.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case SecurityStatus.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case SecurityStatus.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case SecurityStatus.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case SecurityStatus.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case SecurityStatus.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case SecurityStatus.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case SecurityStatus.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case SecurityStatus.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case SecurityStatus.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case SecurityStatus.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case SecurityStatus.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case SecurityStatus.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case SecurityStatus.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case SecurityStatus.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case SecurityStatus.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case SecurityStatus.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case SecurityStatus.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case SecurityStatus.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case SecurityStatus.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case SecurityStatus.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case SecurityStatus.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case SecurityStatus.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case SecurityStatus.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case SecurityStatus.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case SecurityStatus.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case SecurityStatus.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case SecurityStatus.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case SecurityStatus.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case SecurityStatus.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case SecurityStatus.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case SecurityStatus.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case SecurityStatus.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case SecurityStatus.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case SecurityStatus.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case SecurityStatus.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case SecurityStatus.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case SecurityStatus.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case SecurityStatus.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case SecurityStatus.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case SecurityStatus.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case SecurityStatus.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case SecurityStatus.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case SecurityStatus.TAG_UnderlyingEndValue:
	...
	public class SecurityStatusUnderlyingList
	{
		private ArrayList _al;
		private SecurityStatusUnderlying _last;

		public SecurityStatusUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusUnderlying Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case SecurityStatus.TAG_UnderlyingSecurityAltIDSource:
	...
	public class SecurityStatusUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusUnderlyingSecurityAltID _last;

		public SecurityStatusUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusLeg
	{
		...
		private SecurityStatusLegSecurityAltIDList _listLegSecurityAltID = new SecurityStatusLegSecurityAltIDList();
		...
		public SecurityStatusLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_LegSymbol:
						return _sLegSymbol;
					case SecurityStatus.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case SecurityStatus.TAG_LegSecurityID:
						return _sLegSecurityID;
					case SecurityStatus.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case SecurityStatus.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case SecurityStatus.TAG_LegProduct:
						return _iLegProduct;
					case SecurityStatus.TAG_LegCFICode:
						return _sLegCFICode;
					case SecurityStatus.TAG_LegSecurityType:
						return _sLegSecurityType;
					case SecurityStatus.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case SecurityStatus.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case SecurityStatus.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case SecurityStatus.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case SecurityStatus.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case SecurityStatus.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case SecurityStatus.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case SecurityStatus.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case SecurityStatus.TAG_LegFactor:
						return _dLegFactor;
					case SecurityStatus.TAG_LegCreditRating:
						return _sLegCreditRating;
					case SecurityStatus.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case SecurityStatus.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case SecurityStatus.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case SecurityStatus.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case SecurityStatus.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case SecurityStatus.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case SecurityStatus.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case SecurityStatus.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case SecurityStatus.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case SecurityStatus.TAG_LegCouponRate:
						return _dLegCouponRate;
					case SecurityStatus.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case SecurityStatus.TAG_LegIssuer:
						return _sLegIssuer;
					case SecurityStatus.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case SecurityStatus.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case SecurityStatus.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case SecurityStatus.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case SecurityStatus.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case SecurityStatus.TAG_LegRatioQty:
						return _dLegRatioQty;
					case SecurityStatus.TAG_LegSide:
						return _cLegSide;
					case SecurityStatus.TAG_LegCurrency:
						return _sLegCurrency;
					case SecurityStatus.TAG_LegPool:
						return _sLegPool;
					case SecurityStatus.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case SecurityStatus.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case SecurityStatus.TAG_LegInterestAccrualDate:
	...
	public class SecurityStatusLegList
	{
		private ArrayList _al;
		private SecurityStatusLeg _last;

		public SecurityStatusLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusLeg Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatus.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case SecurityStatus.TAG_LegSecurityAltIDSource:
	...
	public class SecurityStatusLegSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusLegSecurityAltID _last;

		public SecurityStatusLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
