...
{
	/// <summary>
	/// Summary description for SecurityDefinition.
	/// </summary>
	public class SecurityDefinition : Message
	{
		...
		private SecurityDefinitionSecurityAltIDList _listSecurityAltID = new SecurityDefinitionSecurityAltIDList();
		...
		private SecurityDefinitionEventList _listEvent = new SecurityDefinitionEventList();
		...
		private SecurityDefinitionInstrAttribList _listInstrAttrib = new SecurityDefinitionInstrAttribList();
		private int _iNoUnderlyings;
		private SecurityDefinitionUnderlyingList _listUnderlying = new SecurityDefinitionUnderlyingList();
		...
		private SecurityDefinitionLegList _listLeg = new SecurityDefinitionLegList();
		...
		{
			_sMsgType = Values.MsgType.SecurityDefinition;
		}
		...
		public SecurityDefinitionSecurityAltIDList SecurityAltID 
		{
		...
		public SecurityDefinitionEventList Event 
		{
		...
		public SecurityDefinitionInstrAttribList InstrAttrib 
		{
		...
		public SecurityDefinitionUnderlyingList Underlying 
		{
		...
		public SecurityDefinitionLegList Leg 
		{
			get { return _listLeg; }
		}
	...
	public class SecurityDefinitionSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_SecurityAltID:
						return _sSecurityAltID;
					case SecurityDefinition.TAG_SecurityAltIDSource:
	...
	public class SecurityDefinitionSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionSecurityAltID _last;

		public SecurityDefinitionSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_EventType:
						return _iEventType;
					case SecurityDefinition.TAG_EventDate:
						return _dtEventDate;
					case SecurityDefinition.TAG_EventPx:
						return _dEventPx;
					case SecurityDefinition.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class SecurityDefinitionEventList
	{
		private ArrayList _al;
		private SecurityDefinitionEvent _last;

		public SecurityDefinitionEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionEvent Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_InstrAttribType:
						return _iInstrAttribType;
					case SecurityDefinition.TAG_InstrAttribValue:
	...
	public class SecurityDefinitionInstrAttribList
	{
		private ArrayList _al;
		private SecurityDefinitionInstrAttrib _last;

		public SecurityDefinitionInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionUnderlying
	{
		...
		private SecurityDefinitionUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new SecurityDefinitionUnderlyingSecurityAltIDList();
		...
		public SecurityDefinitionUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case SecurityDefinition.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case SecurityDefinition.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case SecurityDefinition.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case SecurityDefinition.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case SecurityDefinition.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case SecurityDefinition.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case SecurityDefinition.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case SecurityDefinition.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case SecurityDefinition.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case SecurityDefinition.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case SecurityDefinition.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case SecurityDefinition.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case SecurityDefinition.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case SecurityDefinition.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case SecurityDefinition.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case SecurityDefinition.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case SecurityDefinition.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case SecurityDefinition.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case SecurityDefinition.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case SecurityDefinition.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case SecurityDefinition.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case SecurityDefinition.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case SecurityDefinition.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case SecurityDefinition.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case SecurityDefinition.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case SecurityDefinition.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case SecurityDefinition.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case SecurityDefinition.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case SecurityDefinition.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case SecurityDefinition.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case SecurityDefinition.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case SecurityDefinition.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case SecurityDefinition.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case SecurityDefinition.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case SecurityDefinition.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case SecurityDefinition.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case SecurityDefinition.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case SecurityDefinition.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case SecurityDefinition.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case SecurityDefinition.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case SecurityDefinition.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case SecurityDefinition.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case SecurityDefinition.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case SecurityDefinition.TAG_UnderlyingEndValue:
	...
	public class SecurityDefinitionUnderlyingList
	{
		private ArrayList _al;
		private SecurityDefinitionUnderlying _last;

		public SecurityDefinitionUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionUnderlying Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case SecurityDefinition.TAG_UnderlyingSecurityAltIDSource:
	...
	public class SecurityDefinitionUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionUnderlyingSecurityAltID _last;

		public SecurityDefinitionUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionLeg
	{
		...
		private SecurityDefinitionLegSecurityAltIDList _listLegSecurityAltID = new SecurityDefinitionLegSecurityAltIDList();
		...
		public SecurityDefinitionLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_LegSymbol:
						return _sLegSymbol;
					case SecurityDefinition.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case SecurityDefinition.TAG_LegSecurityID:
						return _sLegSecurityID;
					case SecurityDefinition.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case SecurityDefinition.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case SecurityDefinition.TAG_LegProduct:
						return _iLegProduct;
					case SecurityDefinition.TAG_LegCFICode:
						return _sLegCFICode;
					case SecurityDefinition.TAG_LegSecurityType:
						return _sLegSecurityType;
					case SecurityDefinition.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case SecurityDefinition.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case SecurityDefinition.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case SecurityDefinition.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case SecurityDefinition.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case SecurityDefinition.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case SecurityDefinition.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case SecurityDefinition.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case SecurityDefinition.TAG_LegFactor:
						return _dLegFactor;
					case SecurityDefinition.TAG_LegCreditRating:
						return _sLegCreditRating;
					case SecurityDefinition.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case SecurityDefinition.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case SecurityDefinition.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case SecurityDefinition.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case SecurityDefinition.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case SecurityDefinition.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case SecurityDefinition.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case SecurityDefinition.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case SecurityDefinition.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case SecurityDefinition.TAG_LegCouponRate:
						return _dLegCouponRate;
					case SecurityDefinition.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case SecurityDefinition.TAG_LegIssuer:
						return _sLegIssuer;
					case SecurityDefinition.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case SecurityDefinition.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case SecurityDefinition.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case SecurityDefinition.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case SecurityDefinition.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case SecurityDefinition.TAG_LegRatioQty:
						return _dLegRatioQty;
					case SecurityDefinition.TAG_LegSide:
						return _cLegSide;
					case SecurityDefinition.TAG_LegCurrency:
						return _sLegCurrency;
					case SecurityDefinition.TAG_LegPool:
						return _sLegPool;
					case SecurityDefinition.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case SecurityDefinition.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case SecurityDefinition.TAG_LegInterestAccrualDate:
	...
	public class SecurityDefinitionLegList
	{
		private ArrayList _al;
		private SecurityDefinitionLeg _last;

		public SecurityDefinitionLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionLeg Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinition.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case SecurityDefinition.TAG_LegSecurityAltIDSource:
	...
	public class SecurityDefinitionLegSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionLegSecurityAltID _last;

		public SecurityDefinitionLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
