...
{
	/// <summary>
	/// Summary description for RequestForPositionsAck.
	/// </summary>
	public class RequestForPositionsAck : Message
	{
		...
		public const int TAG_PosReqStatus = 729;
		...
		private int _iPosReqStatus;
		private int _iNoPartyIDs;
		private RequestForPositionsAckPartyIDList _listPartyID = new RequestForPositionsAckPartyIDList();
		...
		private RequestForPositionsAckSecurityAltIDList _listSecurityAltID = new RequestForPositionsAckSecurityAltIDList();
		...
		private RequestForPositionsAckEventList _listEvent = new RequestForPositionsAckEventList();
		private DateTime _dtDatedDate;
		private DateTime _dtInterestAccrualDate;
		private string _sCurrency;
		private int _iNoLegs;
		private RequestForPositionsAckLegList _listLeg = new RequestForPositionsAckLegList();
		private int _iNoUnderlyings;
		private RequestForPositionsAckUnderlyingList _listUnderlying = new RequestForPositionsAckUnderlyingList();
		...
		{
			_sMsgType = Values.MsgType.RequestForPositionsAck;
		}
		...
		{
			get { return _iPosReqStatus; }
			set { _iPosReqStatus = value; }
		}
		...
		public RequestForPositionsAckPartyIDList PartyID 
		{
		...
		public RequestForPositionsAckSecurityAltIDList SecurityAltID 
		{
		...
		public RequestForPositionsAckEventList Event 
		{
		...
		public RequestForPositionsAckLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public RequestForPositionsAckUnderlyingList Underlying 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_PosReqStatus:
						return _iPosReqStatus;
					case TAG_NoPartyIDs:
						return _iNoPartyIDs;
					case TAG_Account:
						return _sAccount;
	...
	public class RequestForPositionsAckPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private RequestForPositionsAckPartySubIDList _listPartySubID = new RequestForPositionsAckPartySubIDList();
		...
		public RequestForPositionsAckPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_PartyID:
						return _sPartyID;
					case RequestForPositionsAck.TAG_PartyIDSource:
						return _cPartyIDSource;
					case RequestForPositionsAck.TAG_PartyRole:
						return _iPartyRole;
					case RequestForPositionsAck.TAG_NoPartySubIDs:
	...
	public class RequestForPositionsAckPartyIDList
	{
		private ArrayList _al;
		private RequestForPositionsAckPartyID _last;

		public RequestForPositionsAckPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckPartyID Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_PartySubID:
						return _sPartySubID;
					case RequestForPositionsAck.TAG_PartySubIDType:
	...
	public class RequestForPositionsAckPartySubIDList
	{
		private ArrayList _al;
		private RequestForPositionsAckPartySubID _last;

		public RequestForPositionsAckPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckPartySubID Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_SecurityAltID:
						return _sSecurityAltID;
					case RequestForPositionsAck.TAG_SecurityAltIDSource:
	...
	public class RequestForPositionsAckSecurityAltIDList
	{
		private ArrayList _al;
		private RequestForPositionsAckSecurityAltID _last;

		public RequestForPositionsAckSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_EventType:
						return _iEventType;
					case RequestForPositionsAck.TAG_EventDate:
						return _dtEventDate;
					case RequestForPositionsAck.TAG_EventPx:
						return _dEventPx;
					case RequestForPositionsAck.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class RequestForPositionsAckEventList
	{
		private ArrayList _al;
		private RequestForPositionsAckEvent _last;

		public RequestForPositionsAckEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckEvent Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckLeg
	{
		...
		private RequestForPositionsAckLegSecurityAltIDList _listLegSecurityAltID = new RequestForPositionsAckLegSecurityAltIDList();
		...
		public RequestForPositionsAckLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_LegSymbol:
						return _sLegSymbol;
					case RequestForPositionsAck.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case RequestForPositionsAck.TAG_LegSecurityID:
						return _sLegSecurityID;
					case RequestForPositionsAck.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case RequestForPositionsAck.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case RequestForPositionsAck.TAG_LegProduct:
						return _iLegProduct;
					case RequestForPositionsAck.TAG_LegCFICode:
						return _sLegCFICode;
					case RequestForPositionsAck.TAG_LegSecurityType:
						return _sLegSecurityType;
					case RequestForPositionsAck.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case RequestForPositionsAck.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case RequestForPositionsAck.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case RequestForPositionsAck.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case RequestForPositionsAck.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case RequestForPositionsAck.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case RequestForPositionsAck.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case RequestForPositionsAck.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case RequestForPositionsAck.TAG_LegFactor:
						return _dLegFactor;
					case RequestForPositionsAck.TAG_LegCreditRating:
						return _sLegCreditRating;
					case RequestForPositionsAck.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case RequestForPositionsAck.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case RequestForPositionsAck.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case RequestForPositionsAck.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case RequestForPositionsAck.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case RequestForPositionsAck.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case RequestForPositionsAck.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case RequestForPositionsAck.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case RequestForPositionsAck.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case RequestForPositionsAck.TAG_LegCouponRate:
						return _dLegCouponRate;
					case RequestForPositionsAck.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case RequestForPositionsAck.TAG_LegIssuer:
						return _sLegIssuer;
					case RequestForPositionsAck.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case RequestForPositionsAck.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case RequestForPositionsAck.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case RequestForPositionsAck.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case RequestForPositionsAck.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case RequestForPositionsAck.TAG_LegRatioQty:
						return _dLegRatioQty;
					case RequestForPositionsAck.TAG_LegSide:
						return _cLegSide;
					case RequestForPositionsAck.TAG_LegCurrency:
						return _sLegCurrency;
					case RequestForPositionsAck.TAG_LegPool:
						return _sLegPool;
					case RequestForPositionsAck.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case RequestForPositionsAck.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case RequestForPositionsAck.TAG_LegInterestAccrualDate:
	...
	public class RequestForPositionsAckLegList
	{
		private ArrayList _al;
		private RequestForPositionsAckLeg _last;

		public RequestForPositionsAckLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckLeg Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case RequestForPositionsAck.TAG_LegSecurityAltIDSource:
	...
	public class RequestForPositionsAckLegSecurityAltIDList
	{
		private ArrayList _al;
		private RequestForPositionsAckLegSecurityAltID _last;

		public RequestForPositionsAckLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckUnderlying
	{
		...
		private RequestForPositionsAckUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new RequestForPositionsAckUnderlyingSecurityAltIDList();
		...
		public RequestForPositionsAckUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case RequestForPositionsAck.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case RequestForPositionsAck.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case RequestForPositionsAck.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case RequestForPositionsAck.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case RequestForPositionsAck.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case RequestForPositionsAck.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case RequestForPositionsAck.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case RequestForPositionsAck.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case RequestForPositionsAck.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case RequestForPositionsAck.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case RequestForPositionsAck.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case RequestForPositionsAck.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case RequestForPositionsAck.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case RequestForPositionsAck.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case RequestForPositionsAck.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case RequestForPositionsAck.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case RequestForPositionsAck.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case RequestForPositionsAck.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case RequestForPositionsAck.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case RequestForPositionsAck.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case RequestForPositionsAck.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case RequestForPositionsAck.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case RequestForPositionsAck.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case RequestForPositionsAck.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case RequestForPositionsAck.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case RequestForPositionsAck.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case RequestForPositionsAck.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case RequestForPositionsAck.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case RequestForPositionsAck.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case RequestForPositionsAck.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case RequestForPositionsAck.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case RequestForPositionsAck.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case RequestForPositionsAck.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case RequestForPositionsAck.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case RequestForPositionsAck.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case RequestForPositionsAck.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case RequestForPositionsAck.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case RequestForPositionsAck.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case RequestForPositionsAck.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case RequestForPositionsAck.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case RequestForPositionsAck.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case RequestForPositionsAck.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case RequestForPositionsAck.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case RequestForPositionsAck.TAG_UnderlyingEndValue:
	...
	public class RequestForPositionsAckUnderlyingList
	{
		private ArrayList _al;
		private RequestForPositionsAckUnderlying _last;

		public RequestForPositionsAckUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckUnderlying Last
		{
			get { return _last; }
		}
	}

	public class RequestForPositionsAckUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case RequestForPositionsAck.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case RequestForPositionsAck.TAG_UnderlyingSecurityAltIDSource:
	...
	public class RequestForPositionsAckUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private RequestForPositionsAckUnderlyingSecurityAltID _last;

		public RequestForPositionsAckUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (RequestForPositionsAckUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(RequestForPositionsAckUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(RequestForPositionsAckUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public RequestForPositionsAckUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}
