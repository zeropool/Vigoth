...
{
	/// <summary>
	/// Summary description for SecurityDefinitionRequest.
	/// </summary>
	public class SecurityDefinitionRequest : Message
	{
		public const int TAG_SecurityReqID = 320;
		public const int TAG_SecurityRequestType = 321;
		...
		private int _iSecurityRequestType;
		...
		private SecurityDefinitionRequestSecurityAltIDList _listSecurityAltID = new SecurityDefinitionRequestSecurityAltIDList();
		...
		private SecurityDefinitionRequestEventList _listEvent = new SecurityDefinitionRequestEventList();
		...
		private SecurityDefinitionRequestInstrAttribList _listInstrAttrib = new SecurityDefinitionRequestInstrAttribList();
		private int _iNoUnderlyings;
		private SecurityDefinitionRequestUnderlyingList _listUnderlying = new SecurityDefinitionRequestUnderlyingList();
		...
		private SecurityDefinitionRequestLegList _listLeg = new SecurityDefinitionRequestLegList();
		private int _iExpirationCycle;
		private char _cSubscriptionRequestType;

		public SecurityDefinitionRequest() : base()
		{
			_sMsgType = Values.MsgType.SecurityDefinitionRequest;
		}
		...
		{
			get { return _iSecurityRequestType; }
			set { _iSecurityRequestType = value; }
		}
		...
		public SecurityDefinitionRequestSecurityAltIDList SecurityAltID 
		{
		...
		public SecurityDefinitionRequestEventList Event 
		{
		...
		public SecurityDefinitionRequestInstrAttribList InstrAttrib 
		{
		...
		public SecurityDefinitionRequestUnderlyingList Underlying 
		{
		...
		public SecurityDefinitionRequestLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_SecurityRequestType:
						return _iSecurityRequestType;
					case TAG_Symbol:
						return _sSymbol;
					case TAG_SymbolSfx:
						return _sSymbolSfx;
			...
			set
			{
				switch (iTag)
				{
					case TAG_SecurityReqID:
						...
						break;
					case TAG_SecurityRequestType:
						_iSecurityRequestType = (int)value;
						break;
					case TAG_Symbol:
	...
	public class SecurityDefinitionRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case SecurityDefinitionRequest.TAG_SecurityAltIDSource:
	...
	public class SecurityDefinitionRequestSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestSecurityAltID _last;

		public SecurityDefinitionRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_EventType:
						return _iEventType;
					case SecurityDefinitionRequest.TAG_EventDate:
						return _dtEventDate;
					case SecurityDefinitionRequest.TAG_EventPx:
						return _dEventPx;
					case SecurityDefinitionRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class SecurityDefinitionRequestEventList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestEvent _last;

		public SecurityDefinitionRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_InstrAttribType:
						return _iInstrAttribType;
					case SecurityDefinitionRequest.TAG_InstrAttribValue:
	...
	public class SecurityDefinitionRequestInstrAttribList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestInstrAttrib _last;

		public SecurityDefinitionRequestInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestUnderlying
	{
		...
		private SecurityDefinitionRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new SecurityDefinitionRequestUnderlyingSecurityAltIDList();
		...
		public SecurityDefinitionRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case SecurityDefinitionRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case SecurityDefinitionRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case SecurityDefinitionRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case SecurityDefinitionRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case SecurityDefinitionRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case SecurityDefinitionRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case SecurityDefinitionRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case SecurityDefinitionRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case SecurityDefinitionRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case SecurityDefinitionRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case SecurityDefinitionRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case SecurityDefinitionRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case SecurityDefinitionRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case SecurityDefinitionRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case SecurityDefinitionRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case SecurityDefinitionRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case SecurityDefinitionRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case SecurityDefinitionRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case SecurityDefinitionRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case SecurityDefinitionRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case SecurityDefinitionRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case SecurityDefinitionRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case SecurityDefinitionRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case SecurityDefinitionRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case SecurityDefinitionRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case SecurityDefinitionRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case SecurityDefinitionRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case SecurityDefinitionRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case SecurityDefinitionRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case SecurityDefinitionRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case SecurityDefinitionRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case SecurityDefinitionRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case SecurityDefinitionRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case SecurityDefinitionRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case SecurityDefinitionRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case SecurityDefinitionRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case SecurityDefinitionRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case SecurityDefinitionRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case SecurityDefinitionRequest.TAG_UnderlyingEndValue:
	...
	public class SecurityDefinitionRequestUnderlyingList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestUnderlying _last;

		public SecurityDefinitionRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case SecurityDefinitionRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class SecurityDefinitionRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestUnderlyingSecurityAltID _last;

		public SecurityDefinitionRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestLeg
	{
		...
		private SecurityDefinitionRequestLegSecurityAltIDList _listLegSecurityAltID = new SecurityDefinitionRequestLegSecurityAltIDList();
		...
		public SecurityDefinitionRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_LegSymbol:
						return _sLegSymbol;
					case SecurityDefinitionRequest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case SecurityDefinitionRequest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case SecurityDefinitionRequest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case SecurityDefinitionRequest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case SecurityDefinitionRequest.TAG_LegProduct:
						return _iLegProduct;
					case SecurityDefinitionRequest.TAG_LegCFICode:
						return _sLegCFICode;
					case SecurityDefinitionRequest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case SecurityDefinitionRequest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case SecurityDefinitionRequest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case SecurityDefinitionRequest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case SecurityDefinitionRequest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case SecurityDefinitionRequest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case SecurityDefinitionRequest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case SecurityDefinitionRequest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case SecurityDefinitionRequest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case SecurityDefinitionRequest.TAG_LegFactor:
						return _dLegFactor;
					case SecurityDefinitionRequest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case SecurityDefinitionRequest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case SecurityDefinitionRequest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case SecurityDefinitionRequest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case SecurityDefinitionRequest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case SecurityDefinitionRequest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case SecurityDefinitionRequest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case SecurityDefinitionRequest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case SecurityDefinitionRequest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case SecurityDefinitionRequest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case SecurityDefinitionRequest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case SecurityDefinitionRequest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case SecurityDefinitionRequest.TAG_LegIssuer:
						return _sLegIssuer;
					case SecurityDefinitionRequest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case SecurityDefinitionRequest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case SecurityDefinitionRequest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case SecurityDefinitionRequest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case SecurityDefinitionRequest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case SecurityDefinitionRequest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case SecurityDefinitionRequest.TAG_LegSide:
						return _cLegSide;
					case SecurityDefinitionRequest.TAG_LegCurrency:
						return _sLegCurrency;
					case SecurityDefinitionRequest.TAG_LegPool:
						return _sLegPool;
					case SecurityDefinitionRequest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case SecurityDefinitionRequest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case SecurityDefinitionRequest.TAG_LegInterestAccrualDate:
	...
	public class SecurityDefinitionRequestLegList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestLeg _last;

		public SecurityDefinitionRequestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestLeg Last
		{
			get { return _last; }
		}
	}

	public class SecurityDefinitionRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityDefinitionRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case SecurityDefinitionRequest.TAG_LegSecurityAltIDSource:
	...
	public class SecurityDefinitionRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityDefinitionRequestLegSecurityAltID _last;

		public SecurityDefinitionRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityDefinitionRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityDefinitionRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityDefinitionRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityDefinitionRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
