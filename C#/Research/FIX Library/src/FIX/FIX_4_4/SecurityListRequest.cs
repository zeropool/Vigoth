...
{
	/// <summary>
	/// Summary description for SecurityListRequest.
	/// </summary>
	public class SecurityListRequest : Message
	{
		...
		private SecurityListRequestSecurityAltIDList _listSecurityAltID = new SecurityListRequestSecurityAltIDList();
		...
		private SecurityListRequestEventList _listEvent = new SecurityListRequestEventList();
		...
		private SecurityListRequestInstrAttribList _listInstrAttrib = new SecurityListRequestInstrAttribList();
		...
		private SecurityListRequestUnderlyingList _listUnderlying = new SecurityListRequestUnderlyingList();
		private int _iNoLegs;
		private SecurityListRequestLegList _listLeg = new SecurityListRequestLegList();
		...
		{
			_sMsgType = Values.MsgType.SecurityListRequest;
		}
		...
		public SecurityListRequestSecurityAltIDList SecurityAltID 
		{
		...
		public SecurityListRequestEventList Event 
		{
		...
		public SecurityListRequestInstrAttribList InstrAttrib 
		{
		...
		public SecurityListRequestUnderlyingList Underlying 
		{
		...
		public SecurityListRequestLegList Leg 
		{
			get { return _listLeg; }
		}
	...
	public class SecurityListRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case SecurityListRequest.TAG_SecurityAltIDSource:
	...
	public class SecurityListRequestSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityListRequestSecurityAltID _last;

		public SecurityListRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_EventType:
						return _iEventType;
					case SecurityListRequest.TAG_EventDate:
						return _dtEventDate;
					case SecurityListRequest.TAG_EventPx:
						return _dEventPx;
					case SecurityListRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class SecurityListRequestEventList
	{
		private ArrayList _al;
		private SecurityListRequestEvent _last;

		public SecurityListRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_InstrAttribType:
						return _iInstrAttribType;
					case SecurityListRequest.TAG_InstrAttribValue:
	...
	public class SecurityListRequestInstrAttribList
	{
		private ArrayList _al;
		private SecurityListRequestInstrAttrib _last;

		public SecurityListRequestInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestUnderlying
	{
		...
		private SecurityListRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new SecurityListRequestUnderlyingSecurityAltIDList();
		...
		public SecurityListRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case SecurityListRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case SecurityListRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case SecurityListRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case SecurityListRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case SecurityListRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case SecurityListRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case SecurityListRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case SecurityListRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case SecurityListRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case SecurityListRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case SecurityListRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case SecurityListRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case SecurityListRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case SecurityListRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case SecurityListRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case SecurityListRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case SecurityListRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case SecurityListRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case SecurityListRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case SecurityListRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case SecurityListRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case SecurityListRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case SecurityListRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case SecurityListRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case SecurityListRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case SecurityListRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case SecurityListRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case SecurityListRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case SecurityListRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case SecurityListRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case SecurityListRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case SecurityListRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case SecurityListRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case SecurityListRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case SecurityListRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case SecurityListRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case SecurityListRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case SecurityListRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case SecurityListRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case SecurityListRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case SecurityListRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case SecurityListRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case SecurityListRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case SecurityListRequest.TAG_UnderlyingEndValue:
	...
	public class SecurityListRequestUnderlyingList
	{
		private ArrayList _al;
		private SecurityListRequestUnderlying _last;

		public SecurityListRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case SecurityListRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class SecurityListRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityListRequestUnderlyingSecurityAltID _last;

		public SecurityListRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestLeg
	{
		...
		private SecurityListRequestLegSecurityAltIDList _listLegSecurityAltID = new SecurityListRequestLegSecurityAltIDList();
		...
		public SecurityListRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_LegSymbol:
						return _sLegSymbol;
					case SecurityListRequest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case SecurityListRequest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case SecurityListRequest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case SecurityListRequest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case SecurityListRequest.TAG_LegProduct:
						return _iLegProduct;
					case SecurityListRequest.TAG_LegCFICode:
						return _sLegCFICode;
					case SecurityListRequest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case SecurityListRequest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case SecurityListRequest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case SecurityListRequest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case SecurityListRequest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case SecurityListRequest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case SecurityListRequest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case SecurityListRequest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case SecurityListRequest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case SecurityListRequest.TAG_LegFactor:
						return _dLegFactor;
					case SecurityListRequest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case SecurityListRequest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case SecurityListRequest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case SecurityListRequest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case SecurityListRequest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case SecurityListRequest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case SecurityListRequest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case SecurityListRequest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case SecurityListRequest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case SecurityListRequest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case SecurityListRequest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case SecurityListRequest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case SecurityListRequest.TAG_LegIssuer:
						return _sLegIssuer;
					case SecurityListRequest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case SecurityListRequest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case SecurityListRequest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case SecurityListRequest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case SecurityListRequest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case SecurityListRequest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case SecurityListRequest.TAG_LegSide:
						return _cLegSide;
					case SecurityListRequest.TAG_LegCurrency:
						return _sLegCurrency;
					case SecurityListRequest.TAG_LegPool:
						return _sLegPool;
					case SecurityListRequest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case SecurityListRequest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case SecurityListRequest.TAG_LegInterestAccrualDate:
	...
	public class SecurityListRequestLegList
	{
		private ArrayList _al;
		private SecurityListRequestLeg _last;

		public SecurityListRequestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestLeg Last
		{
			get { return _last; }
		}
	}

	public class SecurityListRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityListRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case SecurityListRequest.TAG_LegSecurityAltIDSource:
	...
	public class SecurityListRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityListRequestLegSecurityAltID _last;

		public SecurityListRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityListRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityListRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityListRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityListRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
