...
{
	/// <summary>
	/// Summary description for OrderMassCancelReport.
	/// </summary>
	public class OrderMassCancelReport : Message
	{
		...
		public const int TAG_MassCancelRequestType = 530;
		public const int TAG_MassCancelResponse = 531;
		public const int TAG_MassCancelRejectReason = 532;
		public const int TAG_TotalAffectedOrders = 533;
		public const int TAG_NoAffectedOrders = 534;
		public const int TAG_OrigClOrdID = 41;
		public const int TAG_AffectedOrderID = 535;
		public const int TAG_AffectedSecondaryOrderID = 536;
		...
		private char _cMassCancelRequestType;
		private char _cMassCancelResponse;
		private char _cMassCancelRejectReason;
		private int _iTotalAffectedOrders;
		private int _iNoAffectedOrders;
		private OrderMassCancelReportAffectedOrderList _listAffectedOrder = new OrderMassCancelReportAffectedOrderList();
		...
		private OrderMassCancelReportSecurityAltIDList _listSecurityAltID = new OrderMassCancelReportSecurityAltIDList();
		...
		private OrderMassCancelReportEventList _listEvent = new OrderMassCancelReportEventList();
		...
		private OrderMassCancelReportUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new OrderMassCancelReportUnderlyingSecurityAltIDList();
		...
		{
			_sMsgType = Values.MsgType.OrderMassCancelReport;
		}
		...
		{
			get { return _cMassCancelRequestType; }
			set { _cMassCancelRequestType = value; }
		}
		public char MassCancelResponse
		{
			get { return _cMassCancelResponse; }
			set { _cMassCancelResponse = value; }
		}
		public char MassCancelRejectReason
		{
			get { return _cMassCancelRejectReason; }
			set { _cMassCancelRejectReason = value; }
		}
		public int TotalAffectedOrders
		{
			get { return _iTotalAffectedOrders; }
			set { _iTotalAffectedOrders = value; }
		}
		public int NoAffectedOrders
		{
			get { return _iNoAffectedOrders; }
			set { _iNoAffectedOrders = value; }
		}
		public OrderMassCancelReportAffectedOrderList AffectedOrder 
		{
			get { return _listAffectedOrder; }
		}
		...
		public OrderMassCancelReportSecurityAltIDList SecurityAltID 
		{
		...
		public OrderMassCancelReportEventList Event 
		{
		...
		public OrderMassCancelReportUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_MassCancelRequestType:
						return _cMassCancelRequestType;
					case TAG_MassCancelResponse:
						return _cMassCancelResponse;
					case TAG_MassCancelRejectReason:
						return _cMassCancelRejectReason;
					case TAG_TotalAffectedOrders:
						return _iTotalAffectedOrders;
					case TAG_NoAffectedOrders:
						return _iNoAffectedOrders;
			...
			set
			{
				switch (iTag)
				{
					...
					case TAG_SecondaryOrderID:
						...
						break;
					case TAG_MassCancelRequestType:
						_cMassCancelRequestType = (char)value;
						break;
					case TAG_MassCancelResponse:
						_cMassCancelResponse = (char)value;
						break;
					case TAG_MassCancelRejectReason:
						_cMassCancelRejectReason = (char)value;
						break;
					case TAG_TotalAffectedOrders:
						_iTotalAffectedOrders = (int)value;
						break;
					case TAG_NoAffectedOrders:
						_iNoAffectedOrders = (int)value;
						break;
					case TAG_TradingSessionID:
	...
	public class OrderMassCancelReportAffectedOrder
	{
		private string _sOrigClOrdID;
		private string _sAffectedOrderID;
		private string _sAffectedSecondaryOrderID;
		...
		{
			get { return _sAffectedOrderID; }
			set { _sAffectedOrderID = value; }
		}
		public string AffectedSecondaryOrderID
		{
			get { return _sAffectedSecondaryOrderID; }
			set { _sAffectedSecondaryOrderID = value; }
		}
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelReport.TAG_OrigClOrdID:
						return _sOrigClOrdID;
					case OrderMassCancelReport.TAG_AffectedOrderID:
						return _sAffectedOrderID;
					case OrderMassCancelReport.TAG_AffectedSecondaryOrderID:
						return _sAffectedSecondaryOrderID;
					default:
			...
			set
			{
				switch (iTag)
				{
					case OrderMassCancelReport.TAG_OrigClOrdID:
						...
						break;
					case OrderMassCancelReport.TAG_AffectedOrderID:
						_sAffectedOrderID = (string)value;
						break;
					case OrderMassCancelReport.TAG_AffectedSecondaryOrderID:
						_sAffectedSecondaryOrderID = (string)value;
						break;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class OrderMassCancelReportAffectedOrderList
	{
		private ArrayList _al;
		private OrderMassCancelReportAffectedOrder _last;

		public OrderMassCancelReportAffectedOrder this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelReportAffectedOrder)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelReportAffectedOrder item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelReportAffectedOrder item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelReportAffectedOrder Last
		{
			get { return _last; }
		}
	}

	public class OrderMassCancelReportSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelReport.TAG_SecurityAltID:
						return _sSecurityAltID;
					case OrderMassCancelReport.TAG_SecurityAltIDSource:
	...
	public class OrderMassCancelReportSecurityAltIDList
	{
		private ArrayList _al;
		private OrderMassCancelReportSecurityAltID _last;

		public OrderMassCancelReportSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelReportSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelReportSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelReportSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelReportSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class OrderMassCancelReportEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelReport.TAG_EventType:
						return _iEventType;
					case OrderMassCancelReport.TAG_EventDate:
						return _dtEventDate;
					case OrderMassCancelReport.TAG_EventPx:
						return _dEventPx;
					case OrderMassCancelReport.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class OrderMassCancelReportEventList
	{
		private ArrayList _al;
		private OrderMassCancelReportEvent _last;

		public OrderMassCancelReportEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelReportEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelReportEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelReportEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelReportEvent Last
		{
			get { return _last; }
		}
	}

	public class OrderMassCancelReportUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelReport.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case OrderMassCancelReport.TAG_UnderlyingSecurityAltIDSource:
	...
	public class OrderMassCancelReportUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private OrderMassCancelReportUnderlyingSecurityAltID _last;

		public OrderMassCancelReportUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelReportUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelReportUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelReportUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelReportUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}
