...
{
	/// <summary>
	/// Summary description for PositionMaintenanceReport.
	/// </summary>
	public class PositionMaintenanceReport : Message
	{
		...
		public const int TAG_PosMaintStatus = 722;
		public const int TAG_PosMaintResult = 723;
		...
		private int _iPosMaintStatus;
		private int _iPosMaintResult;
		...
		private PositionMaintenanceReportPartyIDList _listPartyID = new PositionMaintenanceReportPartyIDList();
		...
		private PositionMaintenanceReportSecurityAltIDList _listSecurityAltID = new PositionMaintenanceReportSecurityAltIDList();
		...
		private PositionMaintenanceReportEventList _listEvent = new PositionMaintenanceReportEventList();
		private DateTime _dtDatedDate;
		private DateTime _dtInterestAccrualDate;
		private string _sCurrency;
		private int _iNoLegs;
		private PositionMaintenanceReportLegList _listLeg = new PositionMaintenanceReportLegList();
		private int _iNoUnderlyings;
		private PositionMaintenanceReportUnderlyingList _listUnderlying = new PositionMaintenanceReportUnderlyingList();
		private int _iNoTradingSessions;
		private PositionMaintenanceReportTradingSessionList _listTradingSession = new PositionMaintenanceReportTradingSessionList();
		private DateTime _dtTransactTime;
		private int _iNoPositions;
		private PositionMaintenanceReportPositionList _listPosition = new PositionMaintenanceReportPositionList();
		private int _iNoPosAmt;
		private PositionMaintenanceReportPosAmtList _listPosAmt = new PositionMaintenanceReportPosAmtList();
		...
		{
			_sMsgType = Values.MsgType.PositionMaintenanceReport;
		}
		...
		{
			get { return _iPosMaintStatus; }
			set { _iPosMaintStatus = value; }
		}
		public int PosMaintResult
		{
			get { return _iPosMaintResult; }
			set { _iPosMaintResult = value; }
		}
		...
		public PositionMaintenanceReportPartyIDList PartyID 
		{
		...
		public PositionMaintenanceReportSecurityAltIDList SecurityAltID 
		{
		...
		public PositionMaintenanceReportEventList Event 
		{
		...
		public PositionMaintenanceReportLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public PositionMaintenanceReportUnderlyingList Underlying 
		{
		...
		public PositionMaintenanceReportTradingSessionList TradingSession 
		{
		...
		public PositionMaintenanceReportPositionList Position 
		{
		...
		public PositionMaintenanceReportPosAmtList PosAmt 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_PosMaintStatus:
						return _iPosMaintStatus;
					case TAG_PosMaintResult:
						return _iPosMaintResult;
			...
			set
			{
				switch (iTag)
				{
					...
					case TAG_OrigPosReqRefID:
						...
						break;
					case TAG_PosMaintStatus:
						_iPosMaintStatus = (int)value;
						break;
					case TAG_PosMaintResult:
						_iPosMaintResult = (int)value;
						break;
					case TAG_ClearingBusinessDate:
	...
	public class PositionMaintenanceReportPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private PositionMaintenanceReportPartySubIDList _listPartySubID = new PositionMaintenanceReportPartySubIDList();
		...
		public PositionMaintenanceReportPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_PartyID:
						return _sPartyID;
					case PositionMaintenanceReport.TAG_PartyIDSource:
						return _cPartyIDSource;
					case PositionMaintenanceReport.TAG_PartyRole:
						return _iPartyRole;
					case PositionMaintenanceReport.TAG_NoPartySubIDs:
	...
	public class PositionMaintenanceReportPartyIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportPartyID _last;

		public PositionMaintenanceReportPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportPartyID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_PartySubID:
						return _sPartySubID;
					case PositionMaintenanceReport.TAG_PartySubIDType:
	...
	public class PositionMaintenanceReportPartySubIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportPartySubID _last;

		public PositionMaintenanceReportPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportPartySubID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_SecurityAltID:
						return _sSecurityAltID;
					case PositionMaintenanceReport.TAG_SecurityAltIDSource:
	...
	public class PositionMaintenanceReportSecurityAltIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportSecurityAltID _last;

		public PositionMaintenanceReportSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_EventType:
						return _iEventType;
					case PositionMaintenanceReport.TAG_EventDate:
						return _dtEventDate;
					case PositionMaintenanceReport.TAG_EventPx:
						return _dEventPx;
					case PositionMaintenanceReport.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class PositionMaintenanceReportEventList
	{
		private ArrayList _al;
		private PositionMaintenanceReportEvent _last;

		public PositionMaintenanceReportEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportEvent Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportLeg
	{
		...
		private PositionMaintenanceReportLegSecurityAltIDList _listLegSecurityAltID = new PositionMaintenanceReportLegSecurityAltIDList();
		...
		public PositionMaintenanceReportLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_LegSymbol:
						return _sLegSymbol;
					case PositionMaintenanceReport.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case PositionMaintenanceReport.TAG_LegSecurityID:
						return _sLegSecurityID;
					case PositionMaintenanceReport.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case PositionMaintenanceReport.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case PositionMaintenanceReport.TAG_LegProduct:
						return _iLegProduct;
					case PositionMaintenanceReport.TAG_LegCFICode:
						return _sLegCFICode;
					case PositionMaintenanceReport.TAG_LegSecurityType:
						return _sLegSecurityType;
					case PositionMaintenanceReport.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case PositionMaintenanceReport.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case PositionMaintenanceReport.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case PositionMaintenanceReport.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case PositionMaintenanceReport.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case PositionMaintenanceReport.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case PositionMaintenanceReport.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case PositionMaintenanceReport.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case PositionMaintenanceReport.TAG_LegFactor:
						return _dLegFactor;
					case PositionMaintenanceReport.TAG_LegCreditRating:
						return _sLegCreditRating;
					case PositionMaintenanceReport.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case PositionMaintenanceReport.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case PositionMaintenanceReport.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case PositionMaintenanceReport.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case PositionMaintenanceReport.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case PositionMaintenanceReport.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case PositionMaintenanceReport.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case PositionMaintenanceReport.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case PositionMaintenanceReport.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case PositionMaintenanceReport.TAG_LegCouponRate:
						return _dLegCouponRate;
					case PositionMaintenanceReport.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case PositionMaintenanceReport.TAG_LegIssuer:
						return _sLegIssuer;
					case PositionMaintenanceReport.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case PositionMaintenanceReport.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case PositionMaintenanceReport.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case PositionMaintenanceReport.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case PositionMaintenanceReport.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case PositionMaintenanceReport.TAG_LegRatioQty:
						return _dLegRatioQty;
					case PositionMaintenanceReport.TAG_LegSide:
						return _cLegSide;
					case PositionMaintenanceReport.TAG_LegCurrency:
						return _sLegCurrency;
					case PositionMaintenanceReport.TAG_LegPool:
						return _sLegPool;
					case PositionMaintenanceReport.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case PositionMaintenanceReport.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case PositionMaintenanceReport.TAG_LegInterestAccrualDate:
	...
	public class PositionMaintenanceReportLegList
	{
		private ArrayList _al;
		private PositionMaintenanceReportLeg _last;

		public PositionMaintenanceReportLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportLeg Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case PositionMaintenanceReport.TAG_LegSecurityAltIDSource:
	...
	public class PositionMaintenanceReportLegSecurityAltIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportLegSecurityAltID _last;

		public PositionMaintenanceReportLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportUnderlying
	{
		...
		private PositionMaintenanceReportUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new PositionMaintenanceReportUnderlyingSecurityAltIDList();
		...
		public PositionMaintenanceReportUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case PositionMaintenanceReport.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case PositionMaintenanceReport.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case PositionMaintenanceReport.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case PositionMaintenanceReport.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case PositionMaintenanceReport.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case PositionMaintenanceReport.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case PositionMaintenanceReport.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case PositionMaintenanceReport.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case PositionMaintenanceReport.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case PositionMaintenanceReport.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case PositionMaintenanceReport.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case PositionMaintenanceReport.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case PositionMaintenanceReport.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case PositionMaintenanceReport.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case PositionMaintenanceReport.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case PositionMaintenanceReport.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case PositionMaintenanceReport.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case PositionMaintenanceReport.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case PositionMaintenanceReport.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case PositionMaintenanceReport.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case PositionMaintenanceReport.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case PositionMaintenanceReport.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case PositionMaintenanceReport.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case PositionMaintenanceReport.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case PositionMaintenanceReport.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case PositionMaintenanceReport.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case PositionMaintenanceReport.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case PositionMaintenanceReport.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case PositionMaintenanceReport.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case PositionMaintenanceReport.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case PositionMaintenanceReport.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case PositionMaintenanceReport.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case PositionMaintenanceReport.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case PositionMaintenanceReport.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case PositionMaintenanceReport.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case PositionMaintenanceReport.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case PositionMaintenanceReport.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case PositionMaintenanceReport.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case PositionMaintenanceReport.TAG_UnderlyingEndValue:
	...
	public class PositionMaintenanceReportUnderlyingList
	{
		private ArrayList _al;
		private PositionMaintenanceReportUnderlying _last;

		public PositionMaintenanceReportUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportUnderlying Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case PositionMaintenanceReport.TAG_UnderlyingSecurityAltIDSource:
	...
	public class PositionMaintenanceReportUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportUnderlyingSecurityAltID _last;

		public PositionMaintenanceReportUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportTradingSession
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_TradingSessionID:
						return _sTradingSessionID;
					case PositionMaintenanceReport.TAG_TradingSessionSubID:
	...
	public class PositionMaintenanceReportTradingSessionList
	{
		private ArrayList _al;
		private PositionMaintenanceReportTradingSession _last;

		public PositionMaintenanceReportTradingSession this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportTradingSession)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportTradingSession item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportTradingSession item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportTradingSession Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportPosition
	{
		...
		private PositionMaintenanceReportNestedPartyIDList _listNestedPartyID = new PositionMaintenanceReportNestedPartyIDList();
		...
		public PositionMaintenanceReportNestedPartyIDList NestedPartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_PosType:
						return _sPosType;
					case PositionMaintenanceReport.TAG_LongQty:
						return _iLongQty;
					case PositionMaintenanceReport.TAG_ShortQty:
						return _iShortQty;
					case PositionMaintenanceReport.TAG_PosQtyStatus:
						return _iPosQtyStatus;
					case PositionMaintenanceReport.TAG_NoNestedPartyIDs:
	...
	public class PositionMaintenanceReportPositionList
	{
		private ArrayList _al;
		private PositionMaintenanceReportPosition _last;

		public PositionMaintenanceReportPosition this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportPosition)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportPosition item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportPosition item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportPosition Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportNestedPartyID
	{
		...
		private PositionMaintenanceReportNestedPartySubIDList _listNestedPartySubID = new PositionMaintenanceReportNestedPartySubIDList();
		...
		public PositionMaintenanceReportNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_NestedPartyID:
						return _sNestedPartyID;
					case PositionMaintenanceReport.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case PositionMaintenanceReport.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case PositionMaintenanceReport.TAG_NoNestedPartySubIDs:
	...
	public class PositionMaintenanceReportNestedPartyIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportNestedPartyID _last;

		public PositionMaintenanceReportNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case PositionMaintenanceReport.TAG_NestedPartySubIDType:
	...
	public class PositionMaintenanceReportNestedPartySubIDList
	{
		private ArrayList _al;
		private PositionMaintenanceReportNestedPartySubID _last;

		public PositionMaintenanceReportNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportNestedPartySubID Last
		{
			get { return _last; }
		}
	}

	public class PositionMaintenanceReportPosAmt
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case PositionMaintenanceReport.TAG_PosAmtType:
						return _sPosAmtType;
					case PositionMaintenanceReport.TAG_PosAmt:
						return _dPosAmt;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class PositionMaintenanceReportPosAmtList
	{
		private ArrayList _al;
		private PositionMaintenanceReportPosAmt _last;

		public PositionMaintenanceReportPosAmt this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (PositionMaintenanceReportPosAmt)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(PositionMaintenanceReportPosAmt item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(PositionMaintenanceReportPosAmt item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public PositionMaintenanceReportPosAmt Last
		{
			get { return _last; }
		}
	}
