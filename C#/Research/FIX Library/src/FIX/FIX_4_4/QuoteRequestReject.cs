...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class QuoteRequestReject : Message
	{
		...
		private int _iQuoteRequestRejectReason;
		private int _iNoRelatedSym;
		private QuoteRequestRejectRelatedSymList _listRelatedSym = new QuoteRequestRejectRelatedSymList();
		private int _iNoQuoteQualifiers;
		private QuoteRequestRejectQuoteQualifierList _listQuoteQualifier = new QuoteRequestRejectQuoteQualifierList();
		...
		private QuoteRequestRejectPartyIDList _listPartyID = new QuoteRequestRejectPartyIDList();
		...
		{
			_sMsgType = Values.MsgType.QuoteRequestReject;
		}
		...
		{
			get { return _iQuoteRequestRejectReason; }
			set { _iQuoteRequestRejectReason = value; }
		}
		...
		public QuoteRequestRejectRelatedSymList RelatedSym 
		{
		...
		public QuoteRequestRejectQuoteQualifierList QuoteQualifier 
		{
		...
		public QuoteRequestRejectPartyIDList PartyID 
		{
			...
			set
			{
				switch (iTag)
				{
					...
					case TAG_RFQReqID:
						...
						break;
					case TAG_QuoteRequestRejectReason:
						_iQuoteRequestRejectReason = (int)value;
						break;
					case TAG_NoRelatedSym:
	...
	public class QuoteRequestRejectRelatedSym
	{
		...
		private QuoteRequestRejectSecurityAltIDList _listSecurityAltID = new QuoteRequestRejectSecurityAltIDList();
		...
		private QuoteRequestRejectEventList _listEvent = new QuoteRequestRejectEventList();
		...
		private QuoteRequestRejectUnderlyingList _listUnderlying = new QuoteRequestRejectUnderlyingList();
		...
		private QuoteRequestRejectStipulationList _listStipulation = new QuoteRequestRejectStipulationList();
		private string _sAccount;
		private int _iAcctIDSource;
		private int _iAccountType;
		private int _iNoLegs;
		private QuoteRequestRejectLegList _listLeg = new QuoteRequestRejectLegList();
		...
		public QuoteRequestRejectSecurityAltIDList SecurityAltID 
		{
		...
		public QuoteRequestRejectEventList Event 
		{
		...
		public QuoteRequestRejectUnderlyingList Underlying 
		{
		...
		public QuoteRequestRejectStipulationList Stipulation 
		{
		...
		public QuoteRequestRejectLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_Symbol:
						return _sSymbol;
					case QuoteRequestReject.TAG_SymbolSfx:
						return _sSymbolSfx;
					case QuoteRequestReject.TAG_SecurityID:
						return _sSecurityID;
					case QuoteRequestReject.TAG_SecurityIDSource:
						return _sSecurityIDSource;
					case QuoteRequestReject.TAG_NoSecurityAltID:
						return _iNoSecurityAltID;
					case QuoteRequestReject.TAG_Product:
						return _iProduct;
					case QuoteRequestReject.TAG_CFICode:
						return _sCFICode;
					case QuoteRequestReject.TAG_SecurityType:
						return _sSecurityType;
					case QuoteRequestReject.TAG_SecuritySubType:
						return _sSecuritySubType;
					case QuoteRequestReject.TAG_MaturityMonthYear:
						return _dtMaturityMonthYear;
					case QuoteRequestReject.TAG_MaturityDate:
						return _dtMaturityDate;
					case QuoteRequestReject.TAG_CouponPaymentDate:
						return _dtCouponPaymentDate;
					case QuoteRequestReject.TAG_IssueDate:
						return _dtIssueDate;
					case QuoteRequestReject.TAG_RepoCollateralSecurityType:
						return _iRepoCollateralSecurityType;
					case QuoteRequestReject.TAG_RepurchaseTerm:
						return _iRepurchaseTerm;
					case QuoteRequestReject.TAG_RepurchaseRate:
						return _dRepurchaseRate;
					case QuoteRequestReject.TAG_Factor:
						return _dFactor;
					case QuoteRequestReject.TAG_CreditRating:
						return _sCreditRating;
					case QuoteRequestReject.TAG_InstrRegistry:
						return _sInstrRegistry;
					case QuoteRequestReject.TAG_CountryOfIssue:
						return _sCountryOfIssue;
					case QuoteRequestReject.TAG_StateOrProvinceOfIssue:
						return _sStateOrProvinceOfIssue;
					case QuoteRequestReject.TAG_LocaleOfIssue:
						return _sLocaleOfIssue;
					case QuoteRequestReject.TAG_RedemptionDate:
						return _dtRedemptionDate;
					case QuoteRequestReject.TAG_StrikePrice:
						return _dStrikePrice;
					case QuoteRequestReject.TAG_StrikeCurrency:
						return _sStrikeCurrency;
					case QuoteRequestReject.TAG_OptAttribute:
						return _cOptAttribute;
					case QuoteRequestReject.TAG_ContractMultiplier:
						return _dContractMultiplier;
					case QuoteRequestReject.TAG_CouponRate:
						return _dCouponRate;
					case QuoteRequestReject.TAG_SecurityExchange:
						return _sSecurityExchange;
					case QuoteRequestReject.TAG_Issuer:
						return _sIssuer;
					case QuoteRequestReject.TAG_EncodedIssuerLen:
						return _iEncodedIssuerLen;
					case QuoteRequestReject.TAG_EncodedIssuer:
						return _sEncodedIssuer;
					case QuoteRequestReject.TAG_SecurityDesc:
						return _sSecurityDesc;
					case QuoteRequestReject.TAG_EncodedSecurityDescLen:
						return _iEncodedSecurityDescLen;
					case QuoteRequestReject.TAG_EncodedSecurityDesc:
						return _sEncodedSecurityDesc;
					case QuoteRequestReject.TAG_Pool:
						return _sPool;
					case QuoteRequestReject.TAG_ContractSettlMonth:
						return _dtContractSettlMonth;
					case QuoteRequestReject.TAG_CPProgram:
						return _iCPProgram;
					case QuoteRequestReject.TAG_CPRegType:
						return _sCPRegType;
					case QuoteRequestReject.TAG_NoEvents:
						return _iNoEvents;
					case QuoteRequestReject.TAG_DatedDate:
						return _dtDatedDate;
					case QuoteRequestReject.TAG_InterestAccrualDate:
						return _dtInterestAccrualDate;
					case QuoteRequestReject.TAG_AgreementDesc:
						return _sAgreementDesc;
					case QuoteRequestReject.TAG_AgreementID:
						return _sAgreementID;
					case QuoteRequestReject.TAG_AgreementDate:
						return _dtAgreementDate;
					case QuoteRequestReject.TAG_AgreementCurrency:
						return _sAgreementCurrency;
					case QuoteRequestReject.TAG_TerminationType:
						return _iTerminationType;
					case QuoteRequestReject.TAG_StartDate:
						return _dtStartDate;
					case QuoteRequestReject.TAG_EndDate:
						return _dtEndDate;
					case QuoteRequestReject.TAG_DeliveryType:
						return _iDeliveryType;
					case QuoteRequestReject.TAG_MarginRatio:
						return _dMarginRatio;
					case QuoteRequestReject.TAG_NoUnderlyings:
						return _iNoUnderlyings;
					case QuoteRequestReject.TAG_PrevClosePx:
						return _dPrevClosePx;
					case QuoteRequestReject.TAG_QuoteRequestType:
						return _iQuoteRequestType;
					case QuoteRequestReject.TAG_QuoteType:
						return _iQuoteType;
					case QuoteRequestReject.TAG_TradingSessionID:
						return _sTradingSessionID;
					case QuoteRequestReject.TAG_TradingSessionSubID:
						return _sTradingSessionSubID;
					case QuoteRequestReject.TAG_TradeOriginationDate:
						return _dtTradeOriginationDate;
					case QuoteRequestReject.TAG_Side:
						return _cSide;
					case QuoteRequestReject.TAG_QtyType:
						return _iQtyType;
					case QuoteRequestReject.TAG_OrderQty:
						return _iOrderQty;
					case QuoteRequestReject.TAG_CashOrderQty:
						return _iCashOrderQty;
					case QuoteRequestReject.TAG_OrderPercent:
						return _dOrderPercent;
					case QuoteRequestReject.TAG_RoundingDirection:
						return _cRoundingDirection;
					case QuoteRequestReject.TAG_RoundingModulus:
						return _dRoundingModulus;
					case QuoteRequestReject.TAG_SettlType:
						return _cSettlType;
					case QuoteRequestReject.TAG_SettlDate:
						return _dtSettlDate;
					case QuoteRequestReject.TAG_SettlDate2:
						return _dtSettlDate2;
					case QuoteRequestReject.TAG_OrderQty2:
						return _iOrderQty2;
					case QuoteRequestReject.TAG_Currency:
						return _sCurrency;
					case QuoteRequestReject.TAG_NoStipulations:
						return _iNoStipulations;
					case QuoteRequestReject.TAG_Account:
						return _sAccount;
					case QuoteRequestReject.TAG_AcctIDSource:
						return _iAcctIDSource;
					case QuoteRequestReject.TAG_AccountType:
						return _iAccountType;
					case QuoteRequestReject.TAG_NoLegs:
						return _iNoLegs;
					default:
	...
	public class QuoteRequestRejectRelatedSymList
	{
		private ArrayList _al;
		private QuoteRequestRejectRelatedSym _last;

		public QuoteRequestRejectRelatedSym this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectRelatedSym)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectRelatedSym item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectRelatedSym item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectRelatedSym Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_SecurityAltID:
						return _sSecurityAltID;
					case QuoteRequestReject.TAG_SecurityAltIDSource:
	...
	public class QuoteRequestRejectSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectSecurityAltID _last;

		public QuoteRequestRejectSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_EventType:
						return _iEventType;
					case QuoteRequestReject.TAG_EventDate:
						return _dtEventDate;
					case QuoteRequestReject.TAG_EventPx:
						return _dEventPx;
					case QuoteRequestReject.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class QuoteRequestRejectEventList
	{
		private ArrayList _al;
		private QuoteRequestRejectEvent _last;

		public QuoteRequestRejectEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectEvent Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectUnderlying
	{
		...
		private QuoteRequestRejectUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new QuoteRequestRejectUnderlyingSecurityAltIDList();
		...
		public QuoteRequestRejectUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case QuoteRequestReject.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case QuoteRequestReject.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case QuoteRequestReject.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case QuoteRequestReject.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case QuoteRequestReject.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case QuoteRequestReject.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case QuoteRequestReject.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case QuoteRequestReject.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case QuoteRequestReject.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case QuoteRequestReject.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case QuoteRequestReject.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case QuoteRequestReject.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case QuoteRequestReject.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case QuoteRequestReject.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case QuoteRequestReject.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case QuoteRequestReject.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case QuoteRequestReject.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case QuoteRequestReject.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case QuoteRequestReject.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case QuoteRequestReject.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case QuoteRequestReject.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case QuoteRequestReject.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case QuoteRequestReject.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case QuoteRequestReject.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case QuoteRequestReject.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case QuoteRequestReject.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case QuoteRequestReject.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case QuoteRequestReject.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case QuoteRequestReject.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case QuoteRequestReject.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case QuoteRequestReject.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case QuoteRequestReject.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case QuoteRequestReject.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case QuoteRequestReject.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case QuoteRequestReject.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case QuoteRequestReject.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case QuoteRequestReject.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case QuoteRequestReject.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case QuoteRequestReject.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case QuoteRequestReject.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case QuoteRequestReject.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case QuoteRequestReject.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case QuoteRequestReject.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case QuoteRequestReject.TAG_UnderlyingEndValue:
	...
	public class QuoteRequestRejectUnderlyingList
	{
		private ArrayList _al;
		private QuoteRequestRejectUnderlying _last;

		public QuoteRequestRejectUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectUnderlying Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case QuoteRequestReject.TAG_UnderlyingSecurityAltIDSource:
	...
	public class QuoteRequestRejectUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectUnderlyingSecurityAltID _last;

		public QuoteRequestRejectUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_StipulationType:
						return _sStipulationType;
					case QuoteRequestReject.TAG_StipulationValue:
	...
	public class QuoteRequestRejectStipulationList
	{
		private ArrayList _al;
		private QuoteRequestRejectStipulation _last;

		public QuoteRequestRejectStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectStipulation Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectLeg
	{
		...
		private QuoteRequestRejectLegSecurityAltIDList _listLegSecurityAltID = new QuoteRequestRejectLegSecurityAltIDList();
		...
		private QuoteRequestRejectLegStipulationList _listLegStipulation = new QuoteRequestRejectLegStipulationList();
		private int _iNoNestedPartyIDs;
		private QuoteRequestRejectNestedPartyIDList _listNestedPartyID = new QuoteRequestRejectNestedPartyIDList();
		...
		public QuoteRequestRejectLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public QuoteRequestRejectLegStipulationList LegStipulation 
		{
		...
		public QuoteRequestRejectNestedPartyIDList NestedPartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_LegSymbol:
						return _sLegSymbol;
					case QuoteRequestReject.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case QuoteRequestReject.TAG_LegSecurityID:
						return _sLegSecurityID;
					case QuoteRequestReject.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case QuoteRequestReject.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case QuoteRequestReject.TAG_LegProduct:
						return _iLegProduct;
					case QuoteRequestReject.TAG_LegCFICode:
						return _sLegCFICode;
					case QuoteRequestReject.TAG_LegSecurityType:
						return _sLegSecurityType;
					case QuoteRequestReject.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case QuoteRequestReject.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case QuoteRequestReject.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case QuoteRequestReject.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case QuoteRequestReject.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case QuoteRequestReject.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case QuoteRequestReject.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case QuoteRequestReject.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case QuoteRequestReject.TAG_LegFactor:
						return _dLegFactor;
					case QuoteRequestReject.TAG_LegCreditRating:
						return _sLegCreditRating;
					case QuoteRequestReject.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case QuoteRequestReject.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case QuoteRequestReject.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case QuoteRequestReject.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case QuoteRequestReject.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case QuoteRequestReject.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case QuoteRequestReject.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case QuoteRequestReject.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case QuoteRequestReject.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case QuoteRequestReject.TAG_LegCouponRate:
						return _dLegCouponRate;
					case QuoteRequestReject.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case QuoteRequestReject.TAG_LegIssuer:
						return _sLegIssuer;
					case QuoteRequestReject.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case QuoteRequestReject.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case QuoteRequestReject.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case QuoteRequestReject.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case QuoteRequestReject.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case QuoteRequestReject.TAG_LegRatioQty:
						return _dLegRatioQty;
					case QuoteRequestReject.TAG_LegSide:
						return _cLegSide;
					case QuoteRequestReject.TAG_LegCurrency:
						return _sLegCurrency;
					case QuoteRequestReject.TAG_LegPool:
						return _sLegPool;
					case QuoteRequestReject.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case QuoteRequestReject.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case QuoteRequestReject.TAG_LegInterestAccrualDate:
						return _dtLegInterestAccrualDate;
					case QuoteRequestReject.TAG_LegQty:
						return _iLegQty;
					case QuoteRequestReject.TAG_LegSwapType:
						return _iLegSwapType;
					case QuoteRequestReject.TAG_LegSettlType:
						return _cLegSettlType;
					case QuoteRequestReject.TAG_LegSettlDate:
						return _dtLegSettlDate;
					case QuoteRequestReject.TAG_NoLegStipulations:
						return _iNoLegStipulations;
					case QuoteRequestReject.TAG_NoNestedPartyIDs:
						return _iNoNestedPartyIDs;
					case QuoteRequestReject.TAG_LegBenchmarkCurveCurrency:
						return _sLegBenchmarkCurveCurrency;
					case QuoteRequestReject.TAG_LegBenchmarkCurveName:
						return _sLegBenchmarkCurveName;
					case QuoteRequestReject.TAG_LegBenchmarkCurvePoint:
						return _sLegBenchmarkCurvePoint;
					case QuoteRequestReject.TAG_LegBenchmarkPrice:
						return _dLegBenchmarkPrice;
					case QuoteRequestReject.TAG_LegBenchmarkPriceType:
	...
	public class QuoteRequestRejectLegList
	{
		private ArrayList _al;
		private QuoteRequestRejectLeg _last;

		public QuoteRequestRejectLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectLeg Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case QuoteRequestReject.TAG_LegSecurityAltIDSource:
	...
	public class QuoteRequestRejectLegSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectLegSecurityAltID _last;

		public QuoteRequestRejectLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectLegStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_LegStipulationType:
						return _sLegStipulationType;
					case QuoteRequestReject.TAG_LegStipulationValue:
	...
	public class QuoteRequestRejectLegStipulationList
	{
		private ArrayList _al;
		private QuoteRequestRejectLegStipulation _last;

		public QuoteRequestRejectLegStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectLegStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectLegStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectLegStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectLegStipulation Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectNestedPartyID
	{
		...
		private QuoteRequestRejectNestedPartySubIDList _listNestedPartySubID = new QuoteRequestRejectNestedPartySubIDList();
		...
		public QuoteRequestRejectNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_NestedPartyID:
						return _sNestedPartyID;
					case QuoteRequestReject.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case QuoteRequestReject.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case QuoteRequestReject.TAG_NoNestedPartySubIDs:
	...
	public class QuoteRequestRejectNestedPartyIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectNestedPartyID _last;

		public QuoteRequestRejectNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case QuoteRequestReject.TAG_NestedPartySubIDType:
	...
	public class QuoteRequestRejectNestedPartySubIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectNestedPartySubID _last;

		public QuoteRequestRejectNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectNestedPartySubID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectQuoteQualifier
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_QuoteQualifier:
	...
	public class QuoteRequestRejectQuoteQualifierList
	{
		private ArrayList _al;
		private QuoteRequestRejectQuoteQualifier _last;

		public QuoteRequestRejectQuoteQualifier this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectQuoteQualifier)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectQuoteQualifier item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectQuoteQualifier item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectQuoteQualifier Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private QuoteRequestRejectPartySubIDList _listPartySubID = new QuoteRequestRejectPartySubIDList();
		...
		public QuoteRequestRejectPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_PartyID:
						return _sPartyID;
					case QuoteRequestReject.TAG_PartyIDSource:
						return _cPartyIDSource;
					case QuoteRequestReject.TAG_PartyRole:
						return _iPartyRole;
					case QuoteRequestReject.TAG_NoPartySubIDs:
	...
	public class QuoteRequestRejectPartyIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectPartyID _last;

		public QuoteRequestRejectPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectPartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteRequestRejectPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteRequestReject.TAG_PartySubID:
						return _sPartySubID;
					case QuoteRequestReject.TAG_PartySubIDType:
	...
	public class QuoteRequestRejectPartySubIDList
	{
		private ArrayList _al;
		private QuoteRequestRejectPartySubID _last;

		public QuoteRequestRejectPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteRequestRejectPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteRequestRejectPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteRequestRejectPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteRequestRejectPartySubID Last
		{
			get { return _last; }
		}
	}
