...
{
	/// <summary>
	/// Summary description for SecurityStatusRequest.
	/// </summary>
	public class SecurityStatusRequest : Message
	{
		...
		private string _sSecurityStatusReqID;
		...
		private SecurityStatusRequestSecurityAltIDList _listSecurityAltID = new SecurityStatusRequestSecurityAltIDList();
		...
		private SecurityStatusRequestEventList _listEvent = new SecurityStatusRequestEventList();
		...
		private SecurityStatusRequestInstrAttribList _listInstrAttrib = new SecurityStatusRequestInstrAttribList();
		private int _iNoUnderlyings;
		private SecurityStatusRequestUnderlyingList _listUnderlying = new SecurityStatusRequestUnderlyingList();
		private int _iNoLegs;
		private SecurityStatusRequestLegList _listLeg = new SecurityStatusRequestLegList();
		...
		{
			_sMsgType = Values.MsgType.SecurityStatusRequest;
		}
		...
		public SecurityStatusRequestSecurityAltIDList SecurityAltID 
		{
		...
		public SecurityStatusRequestEventList Event 
		{
		...
		public SecurityStatusRequestInstrAttribList InstrAttrib 
		{
		...
		public SecurityStatusRequestUnderlyingList Underlying 
		{
		...
		public SecurityStatusRequestLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TAG_SecurityStatusReqID:
						return _sSecurityStatusReqID;
					case TAG_Symbol:
						return _sSymbol;
					case TAG_SymbolSfx:
						return _sSymbolSfx;
			...
			set
			{
				...
				{
					case TAG_SecurityStatusReqID:
						_sSecurityStatusReqID = (string)value;
						break;
					case TAG_Symbol:
	...
	public class SecurityStatusRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case SecurityStatusRequest.TAG_SecurityAltIDSource:
	...
	public class SecurityStatusRequestSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusRequestSecurityAltID _last;

		public SecurityStatusRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_EventType:
						return _iEventType;
					case SecurityStatusRequest.TAG_EventDate:
						return _dtEventDate;
					case SecurityStatusRequest.TAG_EventPx:
						return _dEventPx;
					case SecurityStatusRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class SecurityStatusRequestEventList
	{
		private ArrayList _al;
		private SecurityStatusRequestEvent _last;

		public SecurityStatusRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestInstrAttrib
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_InstrAttribType:
						return _iInstrAttribType;
					case SecurityStatusRequest.TAG_InstrAttribValue:
	...
	public class SecurityStatusRequestInstrAttribList
	{
		private ArrayList _al;
		private SecurityStatusRequestInstrAttrib _last;

		public SecurityStatusRequestInstrAttrib this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestInstrAttrib)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestInstrAttrib item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestInstrAttrib item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestInstrAttrib Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestUnderlying
	{
		...
		private SecurityStatusRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new SecurityStatusRequestUnderlyingSecurityAltIDList();
		...
		public SecurityStatusRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case SecurityStatusRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case SecurityStatusRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case SecurityStatusRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case SecurityStatusRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case SecurityStatusRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case SecurityStatusRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case SecurityStatusRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case SecurityStatusRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case SecurityStatusRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case SecurityStatusRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case SecurityStatusRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case SecurityStatusRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case SecurityStatusRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case SecurityStatusRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case SecurityStatusRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case SecurityStatusRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case SecurityStatusRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case SecurityStatusRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case SecurityStatusRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case SecurityStatusRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case SecurityStatusRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case SecurityStatusRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case SecurityStatusRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case SecurityStatusRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case SecurityStatusRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case SecurityStatusRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case SecurityStatusRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case SecurityStatusRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case SecurityStatusRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case SecurityStatusRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case SecurityStatusRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case SecurityStatusRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case SecurityStatusRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case SecurityStatusRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case SecurityStatusRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case SecurityStatusRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case SecurityStatusRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case SecurityStatusRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case SecurityStatusRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case SecurityStatusRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case SecurityStatusRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case SecurityStatusRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case SecurityStatusRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case SecurityStatusRequest.TAG_UnderlyingEndValue:
	...
	public class SecurityStatusRequestUnderlyingList
	{
		private ArrayList _al;
		private SecurityStatusRequestUnderlying _last;

		public SecurityStatusRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case SecurityStatusRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class SecurityStatusRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusRequestUnderlyingSecurityAltID _last;

		public SecurityStatusRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestLeg
	{
		...
		private SecurityStatusRequestLegSecurityAltIDList _listLegSecurityAltID = new SecurityStatusRequestLegSecurityAltIDList();
		...
		public SecurityStatusRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_LegSymbol:
						return _sLegSymbol;
					case SecurityStatusRequest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case SecurityStatusRequest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case SecurityStatusRequest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case SecurityStatusRequest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case SecurityStatusRequest.TAG_LegProduct:
						return _iLegProduct;
					case SecurityStatusRequest.TAG_LegCFICode:
						return _sLegCFICode;
					case SecurityStatusRequest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case SecurityStatusRequest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case SecurityStatusRequest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case SecurityStatusRequest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case SecurityStatusRequest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case SecurityStatusRequest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case SecurityStatusRequest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case SecurityStatusRequest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case SecurityStatusRequest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case SecurityStatusRequest.TAG_LegFactor:
						return _dLegFactor;
					case SecurityStatusRequest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case SecurityStatusRequest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case SecurityStatusRequest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case SecurityStatusRequest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case SecurityStatusRequest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case SecurityStatusRequest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case SecurityStatusRequest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case SecurityStatusRequest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case SecurityStatusRequest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case SecurityStatusRequest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case SecurityStatusRequest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case SecurityStatusRequest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case SecurityStatusRequest.TAG_LegIssuer:
						return _sLegIssuer;
					case SecurityStatusRequest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case SecurityStatusRequest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case SecurityStatusRequest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case SecurityStatusRequest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case SecurityStatusRequest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case SecurityStatusRequest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case SecurityStatusRequest.TAG_LegSide:
						return _cLegSide;
					case SecurityStatusRequest.TAG_LegCurrency:
						return _sLegCurrency;
					case SecurityStatusRequest.TAG_LegPool:
						return _sLegPool;
					case SecurityStatusRequest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case SecurityStatusRequest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case SecurityStatusRequest.TAG_LegInterestAccrualDate:
	...
	public class SecurityStatusRequestLegList
	{
		private ArrayList _al;
		private SecurityStatusRequestLeg _last;

		public SecurityStatusRequestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestLeg Last
		{
			get { return _last; }
		}
	}

	public class SecurityStatusRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case SecurityStatusRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case SecurityStatusRequest.TAG_LegSecurityAltIDSource:
	...
	public class SecurityStatusRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private SecurityStatusRequestLegSecurityAltID _last;

		public SecurityStatusRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (SecurityStatusRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(SecurityStatusRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(SecurityStatusRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public SecurityStatusRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
