...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class Advertisement : Message
	{
		...
		private string _sAdvId;
		private string _sAdvTransType;
		private string _sAdvRefID;
		...
		private AdvertisementSecurityAltIDList _listSecurityAltID = new AdvertisementSecurityAltIDList();
		...
		private AdvertisementEventList _listEvent = new AdvertisementEventList();
		private DateTime _dtDatedDate;
		private DateTime _dtInterestAccrualDate;
		private int _iNoLegs;
		private AdvertisementLegList _listLeg = new AdvertisementLegList();
		private int _iNoUnderlyings;
		private AdvertisementUnderlyingList _listUnderlying = new AdvertisementUnderlyingList();
		...
		{
			get { return _sAdvTransType; }
			set { _sAdvTransType = value; }
		}
		public string AdvRefID
		{
			get { return _sAdvRefID; }
			set { _sAdvRefID = value; }
		}
		...
		public AdvertisementSecurityAltIDList SecurityAltID 
		{
		...
		public AdvertisementEventList Event 
		{
		...
		public AdvertisementLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public AdvertisementUnderlyingList Underlying 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case TAG_AdvId:
						return _sAdvId;
					case TAG_AdvTransType:
						return _sAdvTransType;
					case TAG_AdvRefID:
						return _sAdvRefID;
					case TAG_Symbol:
						return _sSymbol;
			...
			set
			{
				...
				{
					case TAG_AdvId:
						_sAdvId = (string)value;
						break;
					case TAG_AdvTransType:
						_sAdvTransType = (string)value;
						break;
					case TAG_AdvRefID:
						_sAdvRefID = (string)value;
						break;
					case TAG_Symbol:
	...
	public class AdvertisementSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_SecurityAltID:
						return _sSecurityAltID;
					case Advertisement.TAG_SecurityAltIDSource:
	...
	public class AdvertisementSecurityAltIDList
	{
		private ArrayList _al;
		private AdvertisementSecurityAltID _last;

		public AdvertisementSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementSecurityAltID Last
		{
			get { return _last; }
		}
	}
	...
	public class AdvertisementEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_EventType:
						return _iEventType;
					case Advertisement.TAG_EventDate:
						return _dtEventDate;
					case Advertisement.TAG_EventPx:
						return _dEventPx;
					case Advertisement.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class AdvertisementEventList
	{
		private ArrayList _al;
		private AdvertisementEvent _last;

		public AdvertisementEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementEvent Last
		{
			get { return _last; }
		}
	}

	public class AdvertisementLeg
	{
		...
		private AdvertisementLegSecurityAltIDList _listLegSecurityAltID = new AdvertisementLegSecurityAltIDList();
		...
		public AdvertisementLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_LegSymbol:
						return _sLegSymbol;
					case Advertisement.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case Advertisement.TAG_LegSecurityID:
						return _sLegSecurityID;
					case Advertisement.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case Advertisement.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case Advertisement.TAG_LegProduct:
						return _iLegProduct;
					case Advertisement.TAG_LegCFICode:
						return _sLegCFICode;
					case Advertisement.TAG_LegSecurityType:
						return _sLegSecurityType;
					case Advertisement.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case Advertisement.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case Advertisement.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case Advertisement.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case Advertisement.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case Advertisement.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case Advertisement.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case Advertisement.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case Advertisement.TAG_LegFactor:
						return _dLegFactor;
					case Advertisement.TAG_LegCreditRating:
						return _sLegCreditRating;
					case Advertisement.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case Advertisement.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case Advertisement.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case Advertisement.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case Advertisement.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case Advertisement.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case Advertisement.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case Advertisement.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case Advertisement.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case Advertisement.TAG_LegCouponRate:
						return _dLegCouponRate;
					case Advertisement.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case Advertisement.TAG_LegIssuer:
						return _sLegIssuer;
					case Advertisement.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case Advertisement.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case Advertisement.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case Advertisement.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case Advertisement.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case Advertisement.TAG_LegRatioQty:
						return _dLegRatioQty;
					case Advertisement.TAG_LegSide:
						return _cLegSide;
					case Advertisement.TAG_LegCurrency:
						return _sLegCurrency;
					case Advertisement.TAG_LegPool:
						return _sLegPool;
					case Advertisement.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case Advertisement.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case Advertisement.TAG_LegInterestAccrualDate:
	...
	public class AdvertisementLegList
	{
		private ArrayList _al;
		private AdvertisementLeg _last;

		public AdvertisementLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementLeg Last
		{
			get { return _last; }
		}
	}

	public class AdvertisementLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case Advertisement.TAG_LegSecurityAltIDSource:
	...
	public class AdvertisementLegSecurityAltIDList
	{
		private ArrayList _al;
		private AdvertisementLegSecurityAltID _last;

		public AdvertisementLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class AdvertisementUnderlying
	{
		...
		private AdvertisementUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new AdvertisementUnderlyingSecurityAltIDList();
		...
		public AdvertisementUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case Advertisement.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case Advertisement.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case Advertisement.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case Advertisement.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case Advertisement.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case Advertisement.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case Advertisement.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case Advertisement.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case Advertisement.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case Advertisement.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case Advertisement.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case Advertisement.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case Advertisement.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case Advertisement.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case Advertisement.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case Advertisement.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case Advertisement.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case Advertisement.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case Advertisement.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case Advertisement.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case Advertisement.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case Advertisement.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case Advertisement.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case Advertisement.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case Advertisement.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case Advertisement.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case Advertisement.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case Advertisement.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case Advertisement.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case Advertisement.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case Advertisement.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case Advertisement.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case Advertisement.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case Advertisement.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case Advertisement.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case Advertisement.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case Advertisement.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case Advertisement.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case Advertisement.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case Advertisement.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case Advertisement.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case Advertisement.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case Advertisement.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case Advertisement.TAG_UnderlyingEndValue:
	...
	public class AdvertisementUnderlyingList
	{
		private ArrayList _al;
		private AdvertisementUnderlying _last;

		public AdvertisementUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementUnderlying Last
		{
			get { return _last; }
		}
	}

	public class AdvertisementUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case Advertisement.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case Advertisement.TAG_UnderlyingSecurityAltIDSource:
	...
	public class AdvertisementUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private AdvertisementUnderlyingSecurityAltID _last;

		public AdvertisementUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (AdvertisementUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(AdvertisementUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(AdvertisementUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public AdvertisementUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}
