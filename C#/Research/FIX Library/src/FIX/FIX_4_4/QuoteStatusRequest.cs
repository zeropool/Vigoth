...
{
	/// <summary>
	/// Summary description for QuoteStatusRequest.
	/// </summary>
	public class QuoteStatusRequest : Message
	{
		...
		private QuoteStatusRequestSecurityAltIDList _listSecurityAltID = new QuoteStatusRequestSecurityAltIDList();
		...
		private QuoteStatusRequestEventList _listEvent = new QuoteStatusRequestEventList();
		...
		private QuoteStatusRequestUnderlyingList _listUnderlying = new QuoteStatusRequestUnderlyingList();
		private int _iNoLegs;
		private QuoteStatusRequestLegList _listLeg = new QuoteStatusRequestLegList();
		private int _iNoPartyIDs;
		private QuoteStatusRequestPartyIDList _listPartyID = new QuoteStatusRequestPartyIDList();
		...
		{
			_sMsgType = Values.MsgType.QuoteStatusRequest;
		}
		...
		public QuoteStatusRequestSecurityAltIDList SecurityAltID 
		{
		...
		public QuoteStatusRequestEventList Event 
		{
		...
		public QuoteStatusRequestUnderlyingList Underlying 
		{
		...
		public QuoteStatusRequestLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public QuoteStatusRequestPartyIDList PartyID 
		{
	...
	public class QuoteStatusRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case QuoteStatusRequest.TAG_SecurityAltIDSource:
	...
	public class QuoteStatusRequestSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteStatusRequestSecurityAltID _last;

		public QuoteStatusRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_EventType:
						return _iEventType;
					case QuoteStatusRequest.TAG_EventDate:
						return _dtEventDate;
					case QuoteStatusRequest.TAG_EventPx:
						return _dEventPx;
					case QuoteStatusRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class QuoteStatusRequestEventList
	{
		private ArrayList _al;
		private QuoteStatusRequestEvent _last;

		public QuoteStatusRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestUnderlying
	{
		...
		private QuoteStatusRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new QuoteStatusRequestUnderlyingSecurityAltIDList();
		...
		public QuoteStatusRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case QuoteStatusRequest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case QuoteStatusRequest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case QuoteStatusRequest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case QuoteStatusRequest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case QuoteStatusRequest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case QuoteStatusRequest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case QuoteStatusRequest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case QuoteStatusRequest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case QuoteStatusRequest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case QuoteStatusRequest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case QuoteStatusRequest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case QuoteStatusRequest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case QuoteStatusRequest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case QuoteStatusRequest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case QuoteStatusRequest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case QuoteStatusRequest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case QuoteStatusRequest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case QuoteStatusRequest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case QuoteStatusRequest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case QuoteStatusRequest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case QuoteStatusRequest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case QuoteStatusRequest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case QuoteStatusRequest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case QuoteStatusRequest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case QuoteStatusRequest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case QuoteStatusRequest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case QuoteStatusRequest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case QuoteStatusRequest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case QuoteStatusRequest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case QuoteStatusRequest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case QuoteStatusRequest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case QuoteStatusRequest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case QuoteStatusRequest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case QuoteStatusRequest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case QuoteStatusRequest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case QuoteStatusRequest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case QuoteStatusRequest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case QuoteStatusRequest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case QuoteStatusRequest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case QuoteStatusRequest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case QuoteStatusRequest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case QuoteStatusRequest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case QuoteStatusRequest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case QuoteStatusRequest.TAG_UnderlyingEndValue:
	...
	public class QuoteStatusRequestUnderlyingList
	{
		private ArrayList _al;
		private QuoteStatusRequestUnderlying _last;

		public QuoteStatusRequestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case QuoteStatusRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class QuoteStatusRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteStatusRequestUnderlyingSecurityAltID _last;

		public QuoteStatusRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestLeg
	{
		...
		private QuoteStatusRequestLegSecurityAltIDList _listLegSecurityAltID = new QuoteStatusRequestLegSecurityAltIDList();
		...
		public QuoteStatusRequestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_LegSymbol:
						return _sLegSymbol;
					case QuoteStatusRequest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case QuoteStatusRequest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case QuoteStatusRequest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case QuoteStatusRequest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case QuoteStatusRequest.TAG_LegProduct:
						return _iLegProduct;
					case QuoteStatusRequest.TAG_LegCFICode:
						return _sLegCFICode;
					case QuoteStatusRequest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case QuoteStatusRequest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case QuoteStatusRequest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case QuoteStatusRequest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case QuoteStatusRequest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case QuoteStatusRequest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case QuoteStatusRequest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case QuoteStatusRequest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case QuoteStatusRequest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case QuoteStatusRequest.TAG_LegFactor:
						return _dLegFactor;
					case QuoteStatusRequest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case QuoteStatusRequest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case QuoteStatusRequest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case QuoteStatusRequest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case QuoteStatusRequest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case QuoteStatusRequest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case QuoteStatusRequest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case QuoteStatusRequest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case QuoteStatusRequest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case QuoteStatusRequest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case QuoteStatusRequest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case QuoteStatusRequest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case QuoteStatusRequest.TAG_LegIssuer:
						return _sLegIssuer;
					case QuoteStatusRequest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case QuoteStatusRequest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case QuoteStatusRequest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case QuoteStatusRequest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case QuoteStatusRequest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case QuoteStatusRequest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case QuoteStatusRequest.TAG_LegSide:
						return _cLegSide;
					case QuoteStatusRequest.TAG_LegCurrency:
						return _sLegCurrency;
					case QuoteStatusRequest.TAG_LegPool:
						return _sLegPool;
					case QuoteStatusRequest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case QuoteStatusRequest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case QuoteStatusRequest.TAG_LegInterestAccrualDate:
	...
	public class QuoteStatusRequestLegList
	{
		private ArrayList _al;
		private QuoteStatusRequestLeg _last;

		public QuoteStatusRequestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestLeg Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case QuoteStatusRequest.TAG_LegSecurityAltIDSource:
	...
	public class QuoteStatusRequestLegSecurityAltIDList
	{
		private ArrayList _al;
		private QuoteStatusRequestLegSecurityAltID _last;

		public QuoteStatusRequestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private QuoteStatusRequestPartySubIDList _listPartySubID = new QuoteStatusRequestPartySubIDList();
		...
		public QuoteStatusRequestPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_PartyID:
						return _sPartyID;
					case QuoteStatusRequest.TAG_PartyIDSource:
						return _cPartyIDSource;
					case QuoteStatusRequest.TAG_PartyRole:
						return _iPartyRole;
					case QuoteStatusRequest.TAG_NoPartySubIDs:
	...
	public class QuoteStatusRequestPartyIDList
	{
		private ArrayList _al;
		private QuoteStatusRequestPartyID _last;

		public QuoteStatusRequestPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestPartyID Last
		{
			get { return _last; }
		}
	}

	public class QuoteStatusRequestPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case QuoteStatusRequest.TAG_PartySubID:
						return _sPartySubID;
					case QuoteStatusRequest.TAG_PartySubIDType:
	...
	public class QuoteStatusRequestPartySubIDList
	{
		private ArrayList _al;
		private QuoteStatusRequestPartySubID _last;

		public QuoteStatusRequestPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (QuoteStatusRequestPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(QuoteStatusRequestPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(QuoteStatusRequestPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public QuoteStatusRequestPartySubID Last
		{
			get { return _last; }
		}
	}
