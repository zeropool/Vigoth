...
{
	/// <summary>
	/// Summary description for DontKnowTrade.
	/// </summary>
	public class DontKnowTrade : Message
	{
		...
		private DontKnowTradeSecurityAltIDList _listSecurityAltID = new DontKnowTradeSecurityAltIDList();
		...
		private DontKnowTradeEventList _listEvent = new DontKnowTradeEventList();
		private DateTime _dtDatedDate;
		private DateTime _dtInterestAccrualDate;
		private int _iNoUnderlyings;
		private DontKnowTradeUnderlyingList _listUnderlying = new DontKnowTradeUnderlyingList();
		private int _iNoLegs;
		private DontKnowTradeLegList _listLeg = new DontKnowTradeLegList();
		private char _cSide;
		...
		public DontKnowTradeSecurityAltIDList SecurityAltID 
		{
		...
		public DontKnowTradeEventList Event 
		{
		...
		public DontKnowTradeUnderlyingList Underlying 
		{
		...
		public DontKnowTradeLegList Leg 
		{
			get { return _listLeg; }
		}
		public char Side
	...
	public class DontKnowTradeSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_SecurityAltID:
						return _sSecurityAltID;
					case DontKnowTrade.TAG_SecurityAltIDSource:
	...
	public class DontKnowTradeSecurityAltIDList
	{
		private ArrayList _al;
		private DontKnowTradeSecurityAltID _last;

		public DontKnowTradeSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class DontKnowTradeEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_EventType:
						return _iEventType;
					case DontKnowTrade.TAG_EventDate:
						return _dtEventDate;
					case DontKnowTrade.TAG_EventPx:
						return _dEventPx;
					case DontKnowTrade.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class DontKnowTradeEventList
	{
		private ArrayList _al;
		private DontKnowTradeEvent _last;

		public DontKnowTradeEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeEvent Last
		{
			get { return _last; }
		}
	}

	public class DontKnowTradeUnderlying
	{
		...
		private DontKnowTradeUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new DontKnowTradeUnderlyingSecurityAltIDList();
		...
		public DontKnowTradeUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case DontKnowTrade.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case DontKnowTrade.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case DontKnowTrade.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case DontKnowTrade.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case DontKnowTrade.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case DontKnowTrade.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case DontKnowTrade.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case DontKnowTrade.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case DontKnowTrade.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case DontKnowTrade.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case DontKnowTrade.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case DontKnowTrade.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case DontKnowTrade.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case DontKnowTrade.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case DontKnowTrade.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case DontKnowTrade.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case DontKnowTrade.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case DontKnowTrade.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case DontKnowTrade.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case DontKnowTrade.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case DontKnowTrade.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case DontKnowTrade.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case DontKnowTrade.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case DontKnowTrade.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case DontKnowTrade.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case DontKnowTrade.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case DontKnowTrade.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case DontKnowTrade.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case DontKnowTrade.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case DontKnowTrade.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case DontKnowTrade.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case DontKnowTrade.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case DontKnowTrade.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case DontKnowTrade.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case DontKnowTrade.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case DontKnowTrade.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case DontKnowTrade.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case DontKnowTrade.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case DontKnowTrade.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case DontKnowTrade.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case DontKnowTrade.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case DontKnowTrade.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case DontKnowTrade.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case DontKnowTrade.TAG_UnderlyingEndValue:
	...
	public class DontKnowTradeUnderlyingList
	{
		private ArrayList _al;
		private DontKnowTradeUnderlying _last;

		public DontKnowTradeUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeUnderlying Last
		{
			get { return _last; }
		}
	}

	public class DontKnowTradeUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case DontKnowTrade.TAG_UnderlyingSecurityAltIDSource:
	...
	public class DontKnowTradeUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private DontKnowTradeUnderlyingSecurityAltID _last;

		public DontKnowTradeUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class DontKnowTradeLeg
	{
		...
		private DontKnowTradeLegSecurityAltIDList _listLegSecurityAltID = new DontKnowTradeLegSecurityAltIDList();
		...
		public DontKnowTradeLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_LegSymbol:
						return _sLegSymbol;
					case DontKnowTrade.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case DontKnowTrade.TAG_LegSecurityID:
						return _sLegSecurityID;
					case DontKnowTrade.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case DontKnowTrade.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case DontKnowTrade.TAG_LegProduct:
						return _iLegProduct;
					case DontKnowTrade.TAG_LegCFICode:
						return _sLegCFICode;
					case DontKnowTrade.TAG_LegSecurityType:
						return _sLegSecurityType;
					case DontKnowTrade.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case DontKnowTrade.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case DontKnowTrade.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case DontKnowTrade.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case DontKnowTrade.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case DontKnowTrade.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case DontKnowTrade.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case DontKnowTrade.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case DontKnowTrade.TAG_LegFactor:
						return _dLegFactor;
					case DontKnowTrade.TAG_LegCreditRating:
						return _sLegCreditRating;
					case DontKnowTrade.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case DontKnowTrade.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case DontKnowTrade.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case DontKnowTrade.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case DontKnowTrade.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case DontKnowTrade.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case DontKnowTrade.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case DontKnowTrade.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case DontKnowTrade.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case DontKnowTrade.TAG_LegCouponRate:
						return _dLegCouponRate;
					case DontKnowTrade.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case DontKnowTrade.TAG_LegIssuer:
						return _sLegIssuer;
					case DontKnowTrade.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case DontKnowTrade.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case DontKnowTrade.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case DontKnowTrade.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case DontKnowTrade.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case DontKnowTrade.TAG_LegRatioQty:
						return _dLegRatioQty;
					case DontKnowTrade.TAG_LegSide:
						return _cLegSide;
					case DontKnowTrade.TAG_LegCurrency:
						return _sLegCurrency;
					case DontKnowTrade.TAG_LegPool:
						return _sLegPool;
					case DontKnowTrade.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case DontKnowTrade.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case DontKnowTrade.TAG_LegInterestAccrualDate:
	...
	public class DontKnowTradeLegList
	{
		private ArrayList _al;
		private DontKnowTradeLeg _last;

		public DontKnowTradeLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeLeg Last
		{
			get { return _last; }
		}
	}

	public class DontKnowTradeLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case DontKnowTrade.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case DontKnowTrade.TAG_LegSecurityAltIDSource:
	...
	public class DontKnowTradeLegSecurityAltIDList
	{
		private ArrayList _al;
		private DontKnowTradeLegSecurityAltID _last;

		public DontKnowTradeLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (DontKnowTradeLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(DontKnowTradeLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(DontKnowTradeLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public DontKnowTradeLegSecurityAltID Last
		{
			get { return _last; }
		}
	}
