...
namespace FIX4NET.FIX.FIX_4_4
{
	...
	public class IndicationOfInterest : Message
	{
		...
		public const int TAG_IOIQty = 27;
		...
		public const int TAG_LegIOIQty = 682;
		...
		private IndicationOfInterestSecurityAltIDList _listSecurityAltID = new IndicationOfInterestSecurityAltIDList();
		...
		private IndicationOfInterestEventList _listEvent = new IndicationOfInterestEventList();
		...
		private IndicationOfInterestUnderlyingList _listUnderlying = new IndicationOfInterestUnderlyingList();
		private char _cSide;
		...
		private string _sIOIQty;
		private string _sCurrency;
		private int _iNoStipulations;
		private IndicationOfInterestStipulationList _listStipulation = new IndicationOfInterestStipulationList();
		private int _iNoLegs;
		private IndicationOfInterestLegList _listLeg = new IndicationOfInterestLegList();
		...
		private IndicationOfInterestIOIQualifierList _listIOIQualifier = new IndicationOfInterestIOIQualifierList();
		...
		private IndicationOfInterestRoutingIDList _listRoutingID = new IndicationOfInterestRoutingIDList();
		...
		public IndicationOfInterestSecurityAltIDList SecurityAltID 
		{
		...
		public IndicationOfInterestEventList Event 
		{
		...
		public IndicationOfInterestUnderlyingList Underlying 
		{
		...
		public IndicationOfInterestStipulationList Stipulation 
		{
		...
		public IndicationOfInterestLegList Leg 
		{
			get { return _listLeg; }
		}
		...
		public IndicationOfInterestIOIQualifierList IOIQualifier 
		{
			get { return _listIOIQualifier; }
		}
		public string Text
		{
			get { return _sText; }
		...
		public IndicationOfInterestRoutingIDList RoutingID 
		{
		...
		public override object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					...
					case TAG_IOIQltyInd:
						return _cIOIQltyInd;
					case TAG_IOINaturalFlag:
						return _bIOINaturalFlag;
					case TAG_NoIOIQualifiers:
	...
	public class IndicationOfInterestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case IndicationOfInterest.TAG_SecurityAltIDSource:
	...
	public class IndicationOfInterestSecurityAltIDList
	{
		private ArrayList _al;
		private IndicationOfInterestSecurityAltID _last;

		public IndicationOfInterestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_EventType:
						return _iEventType;
					case IndicationOfInterest.TAG_EventDate:
						return _dtEventDate;
					case IndicationOfInterest.TAG_EventPx:
						return _dEventPx;
					case IndicationOfInterest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class IndicationOfInterestEventList
	{
		private ArrayList _al;
		private IndicationOfInterestEvent _last;

		public IndicationOfInterestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestEvent Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestUnderlying
	{
		...
		private IndicationOfInterestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new IndicationOfInterestUnderlyingSecurityAltIDList();
		...
		public IndicationOfInterestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case IndicationOfInterest.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case IndicationOfInterest.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case IndicationOfInterest.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case IndicationOfInterest.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case IndicationOfInterest.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case IndicationOfInterest.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case IndicationOfInterest.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case IndicationOfInterest.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case IndicationOfInterest.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case IndicationOfInterest.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case IndicationOfInterest.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case IndicationOfInterest.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case IndicationOfInterest.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case IndicationOfInterest.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case IndicationOfInterest.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case IndicationOfInterest.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case IndicationOfInterest.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case IndicationOfInterest.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case IndicationOfInterest.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case IndicationOfInterest.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case IndicationOfInterest.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case IndicationOfInterest.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case IndicationOfInterest.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case IndicationOfInterest.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case IndicationOfInterest.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case IndicationOfInterest.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case IndicationOfInterest.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case IndicationOfInterest.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case IndicationOfInterest.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case IndicationOfInterest.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case IndicationOfInterest.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case IndicationOfInterest.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case IndicationOfInterest.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case IndicationOfInterest.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case IndicationOfInterest.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case IndicationOfInterest.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case IndicationOfInterest.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case IndicationOfInterest.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case IndicationOfInterest.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case IndicationOfInterest.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case IndicationOfInterest.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case IndicationOfInterest.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case IndicationOfInterest.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case IndicationOfInterest.TAG_UnderlyingEndValue:
	...
	public class IndicationOfInterestUnderlyingList
	{
		private ArrayList _al;
		private IndicationOfInterestUnderlying _last;

		public IndicationOfInterestUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestUnderlying Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case IndicationOfInterest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class IndicationOfInterestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private IndicationOfInterestUnderlyingSecurityAltID _last;

		public IndicationOfInterestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_StipulationType:
						return _sStipulationType;
					case IndicationOfInterest.TAG_StipulationValue:
	...
	public class IndicationOfInterestStipulationList
	{
		private ArrayList _al;
		private IndicationOfInterestStipulation _last;

		public IndicationOfInterestStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestStipulation Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestLeg
	{
		...
		private IndicationOfInterestLegSecurityAltIDList _listLegSecurityAltID = new IndicationOfInterestLegSecurityAltIDList();
		...
		private string _sLegIOIQty;
		private int _iNoLegStipulations;
		private IndicationOfInterestLegStipulationList _listLegStipulation = new IndicationOfInterestLegStipulationList();
		...
		public IndicationOfInterestLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public string LegIOIQty
		{
			get { return _sLegIOIQty; }
			set { _sLegIOIQty = value; }
		}
		...
		public IndicationOfInterestLegStipulationList LegStipulation 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_LegSymbol:
						return _sLegSymbol;
					case IndicationOfInterest.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case IndicationOfInterest.TAG_LegSecurityID:
						return _sLegSecurityID;
					case IndicationOfInterest.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case IndicationOfInterest.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case IndicationOfInterest.TAG_LegProduct:
						return _iLegProduct;
					case IndicationOfInterest.TAG_LegCFICode:
						return _sLegCFICode;
					case IndicationOfInterest.TAG_LegSecurityType:
						return _sLegSecurityType;
					case IndicationOfInterest.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case IndicationOfInterest.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case IndicationOfInterest.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case IndicationOfInterest.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case IndicationOfInterest.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case IndicationOfInterest.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case IndicationOfInterest.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case IndicationOfInterest.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case IndicationOfInterest.TAG_LegFactor:
						return _dLegFactor;
					case IndicationOfInterest.TAG_LegCreditRating:
						return _sLegCreditRating;
					case IndicationOfInterest.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case IndicationOfInterest.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case IndicationOfInterest.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case IndicationOfInterest.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case IndicationOfInterest.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case IndicationOfInterest.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case IndicationOfInterest.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case IndicationOfInterest.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case IndicationOfInterest.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case IndicationOfInterest.TAG_LegCouponRate:
						return _dLegCouponRate;
					case IndicationOfInterest.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case IndicationOfInterest.TAG_LegIssuer:
						return _sLegIssuer;
					case IndicationOfInterest.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case IndicationOfInterest.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case IndicationOfInterest.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case IndicationOfInterest.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case IndicationOfInterest.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case IndicationOfInterest.TAG_LegRatioQty:
						return _dLegRatioQty;
					case IndicationOfInterest.TAG_LegSide:
						return _cLegSide;
					case IndicationOfInterest.TAG_LegCurrency:
						return _sLegCurrency;
					case IndicationOfInterest.TAG_LegPool:
						return _sLegPool;
					case IndicationOfInterest.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case IndicationOfInterest.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case IndicationOfInterest.TAG_LegInterestAccrualDate:
						return _dtLegInterestAccrualDate;
					case IndicationOfInterest.TAG_LegIOIQty:
						return _sLegIOIQty;
					case IndicationOfInterest.TAG_NoLegStipulations:
	...
	public class IndicationOfInterestLegList
	{
		private ArrayList _al;
		private IndicationOfInterestLeg _last;

		public IndicationOfInterestLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestLeg Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case IndicationOfInterest.TAG_LegSecurityAltIDSource:
	...
	public class IndicationOfInterestLegSecurityAltIDList
	{
		private ArrayList _al;
		private IndicationOfInterestLegSecurityAltID _last;

		public IndicationOfInterestLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestLegStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_LegStipulationType:
						return _sLegStipulationType;
					case IndicationOfInterest.TAG_LegStipulationValue:
	...
	public class IndicationOfInterestLegStipulationList
	{
		private ArrayList _al;
		private IndicationOfInterestLegStipulation _last;

		public IndicationOfInterestLegStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestLegStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestLegStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestLegStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestLegStipulation Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestIOIQualifier
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_IOIQualifier:
	...
	public class IndicationOfInterestIOIQualifierList
	{
		private ArrayList _al;
		private IndicationOfInterestIOIQualifier _last;

		public IndicationOfInterestIOIQualifier this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestIOIQualifier)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestIOIQualifier item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestIOIQualifier item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestIOIQualifier Last
		{
			get { return _last; }
		}
	}

	public class IndicationOfInterestRoutingID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case IndicationOfInterest.TAG_RoutingType:
						return _iRoutingType;
					case IndicationOfInterest.TAG_RoutingID:
						return _sRoutingID;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class IndicationOfInterestRoutingIDList
	{
		private ArrayList _al;
		private IndicationOfInterestRoutingID _last;

		public IndicationOfInterestRoutingID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (IndicationOfInterestRoutingID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(IndicationOfInterestRoutingID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(IndicationOfInterestRoutingID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public IndicationOfInterestRoutingID Last
		{
			get { return _last; }
		}
	}
