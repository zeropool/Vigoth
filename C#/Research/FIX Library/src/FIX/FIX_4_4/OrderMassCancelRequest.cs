...
{
	/// <summary>
	/// Summary description for OrderMassCancelRequest.
	/// </summary>
	public class OrderMassCancelRequest : Message
	{
		...
		private OrderMassCancelRequestSecurityAltIDList _listSecurityAltID = new OrderMassCancelRequestSecurityAltIDList();
		...
		private OrderMassCancelRequestEventList _listEvent = new OrderMassCancelRequestEventList();
		...
		private OrderMassCancelRequestUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new OrderMassCancelRequestUnderlyingSecurityAltIDList();
		...
		{
			_sMsgType = Values.MsgType.OrderMassCancelRequest;
		}
		...
		public OrderMassCancelRequestSecurityAltIDList SecurityAltID 
		{
		...
		public OrderMassCancelRequestEventList Event 
		{
		...
		public OrderMassCancelRequestUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
	...
	public class OrderMassCancelRequestSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelRequest.TAG_SecurityAltID:
						return _sSecurityAltID;
					case OrderMassCancelRequest.TAG_SecurityAltIDSource:
	...
	public class OrderMassCancelRequestSecurityAltIDList
	{
		private ArrayList _al;
		private OrderMassCancelRequestSecurityAltID _last;

		public OrderMassCancelRequestSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelRequestSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelRequestSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelRequestSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelRequestSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class OrderMassCancelRequestEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelRequest.TAG_EventType:
						return _iEventType;
					case OrderMassCancelRequest.TAG_EventDate:
						return _dtEventDate;
					case OrderMassCancelRequest.TAG_EventPx:
						return _dEventPx;
					case OrderMassCancelRequest.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class OrderMassCancelRequestEventList
	{
		private ArrayList _al;
		private OrderMassCancelRequestEvent _last;

		public OrderMassCancelRequestEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelRequestEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelRequestEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelRequestEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelRequestEvent Last
		{
			get { return _last; }
		}
	}

	public class OrderMassCancelRequestUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case OrderMassCancelRequest.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case OrderMassCancelRequest.TAG_UnderlyingSecurityAltIDSource:
	...
	public class OrderMassCancelRequestUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private OrderMassCancelRequestUnderlyingSecurityAltID _last;

		public OrderMassCancelRequestUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (OrderMassCancelRequestUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(OrderMassCancelRequestUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(OrderMassCancelRequestUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public OrderMassCancelRequestUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}
