...
{
	/// <summary>
	/// Summary description for NewOrderSingle.
	/// </summary>
	public class NewOrderSingle : Message
	{
		...
		private NewOrderSinglePartyIDList _listPartyID = new NewOrderSinglePartyIDList();
		...
		private NewOrderSingleAllocList _listAlloc = new NewOrderSingleAllocList();
		...
		private NewOrderSingleTradingSessionList _listTradingSession = new NewOrderSingleTradingSessionList();
		...
		private NewOrderSingleSecurityAltIDList _listSecurityAltID = new NewOrderSingleSecurityAltIDList();
		...
		private NewOrderSingleEventList _listEvent = new NewOrderSingleEventList();
		...
		private NewOrderSingleUnderlyingList _listUnderlying = new NewOrderSingleUnderlyingList();
		private double _dPrevClosePx;
		private char _cSide;
		private bool _bLocateReqd;
		private DateTime _dtTransactTime;
		private int _iNoStipulations;
		private NewOrderSingleStipulationList _listStipulation = new NewOrderSingleStipulationList();
		...
		public NewOrderSinglePartyIDList PartyID 
		{
		...
		public NewOrderSingleAllocList Alloc 
		{
		...
		public NewOrderSingleTradingSessionList TradingSession 
		{
		...
		public NewOrderSingleSecurityAltIDList SecurityAltID 
		{
		...
		public NewOrderSingleEventList Event 
		{
		...
		public NewOrderSingleUnderlyingList Underlying 
		{
		...
		public NewOrderSingleStipulationList Stipulation 
		{
	...
	public class NewOrderSinglePartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private NewOrderSinglePartySubIDList _listPartySubID = new NewOrderSinglePartySubIDList();
		...
		public NewOrderSinglePartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_PartyID:
						return _sPartyID;
					case NewOrderSingle.TAG_PartyIDSource:
						return _cPartyIDSource;
					case NewOrderSingle.TAG_PartyRole:
						return _iPartyRole;
					case NewOrderSingle.TAG_NoPartySubIDs:
	...
	public class NewOrderSinglePartyIDList
	{
		private ArrayList _al;
		private NewOrderSinglePartyID _last;

		public NewOrderSinglePartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSinglePartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSinglePartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSinglePartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSinglePartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSinglePartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_PartySubID:
						return _sPartySubID;
					case NewOrderSingle.TAG_PartySubIDType:
	...
	public class NewOrderSinglePartySubIDList
	{
		private ArrayList _al;
		private NewOrderSinglePartySubID _last;

		public NewOrderSinglePartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSinglePartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSinglePartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSinglePartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSinglePartySubID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleAlloc
	{
		...
		private NewOrderSingleNestedPartyIDList _listNestedPartyID = new NewOrderSingleNestedPartyIDList();
		...
		public NewOrderSingleNestedPartyIDList NestedPartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_AllocAccount:
						return _sAllocAccount;
					case NewOrderSingle.TAG_AllocAcctIDSource:
						return _iAllocAcctIDSource;
					case NewOrderSingle.TAG_AllocSettlCurrency:
						return _sAllocSettlCurrency;
					case NewOrderSingle.TAG_IndividualAllocID:
						return _sIndividualAllocID;
					case NewOrderSingle.TAG_NoNestedPartyIDs:
						return _iNoNestedPartyIDs;
					case NewOrderSingle.TAG_AllocQty:
						return _iAllocQty;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class NewOrderSingleAllocList
	{
		private ArrayList _al;
		private NewOrderSingleAlloc _last;

		public NewOrderSingleAlloc this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleAlloc)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleAlloc item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleAlloc item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleAlloc Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleNestedPartyID
	{
		...
		private NewOrderSingleNestedPartySubIDList _listNestedPartySubID = new NewOrderSingleNestedPartySubIDList();
		...
		public NewOrderSingleNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_NestedPartyID:
						return _sNestedPartyID;
					case NewOrderSingle.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case NewOrderSingle.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case NewOrderSingle.TAG_NoNestedPartySubIDs:
	...
	public class NewOrderSingleNestedPartyIDList
	{
		private ArrayList _al;
		private NewOrderSingleNestedPartyID _last;

		public NewOrderSingleNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case NewOrderSingle.TAG_NestedPartySubIDType:
	...
	public class NewOrderSingleNestedPartySubIDList
	{
		private ArrayList _al;
		private NewOrderSingleNestedPartySubID _last;

		public NewOrderSingleNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleNestedPartySubID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleTradingSession
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_TradingSessionID:
						return _sTradingSessionID;
					case NewOrderSingle.TAG_TradingSessionSubID:
	...
	public class NewOrderSingleTradingSessionList
	{
		private ArrayList _al;
		private NewOrderSingleTradingSession _last;

		public NewOrderSingleTradingSession this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleTradingSession)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleTradingSession item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleTradingSession item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleTradingSession Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_SecurityAltID:
						return _sSecurityAltID;
					case NewOrderSingle.TAG_SecurityAltIDSource:
	...
	public class NewOrderSingleSecurityAltIDList
	{
		private ArrayList _al;
		private NewOrderSingleSecurityAltID _last;

		public NewOrderSingleSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_EventType:
						return _iEventType;
					case NewOrderSingle.TAG_EventDate:
						return _dtEventDate;
					case NewOrderSingle.TAG_EventPx:
						return _dEventPx;
					case NewOrderSingle.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class NewOrderSingleEventList
	{
		private ArrayList _al;
		private NewOrderSingleEvent _last;

		public NewOrderSingleEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleEvent Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleUnderlying
	{
		...
		private NewOrderSingleUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new NewOrderSingleUnderlyingSecurityAltIDList();
		...
		public NewOrderSingleUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case NewOrderSingle.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case NewOrderSingle.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case NewOrderSingle.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case NewOrderSingle.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case NewOrderSingle.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case NewOrderSingle.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case NewOrderSingle.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case NewOrderSingle.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case NewOrderSingle.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case NewOrderSingle.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case NewOrderSingle.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case NewOrderSingle.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case NewOrderSingle.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case NewOrderSingle.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case NewOrderSingle.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case NewOrderSingle.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case NewOrderSingle.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case NewOrderSingle.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case NewOrderSingle.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case NewOrderSingle.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case NewOrderSingle.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case NewOrderSingle.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case NewOrderSingle.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case NewOrderSingle.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case NewOrderSingle.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case NewOrderSingle.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case NewOrderSingle.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case NewOrderSingle.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case NewOrderSingle.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case NewOrderSingle.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case NewOrderSingle.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case NewOrderSingle.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case NewOrderSingle.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case NewOrderSingle.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case NewOrderSingle.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case NewOrderSingle.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case NewOrderSingle.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case NewOrderSingle.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case NewOrderSingle.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case NewOrderSingle.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case NewOrderSingle.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case NewOrderSingle.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case NewOrderSingle.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case NewOrderSingle.TAG_UnderlyingEndValue:
	...
	public class NewOrderSingleUnderlyingList
	{
		private ArrayList _al;
		private NewOrderSingleUnderlying _last;

		public NewOrderSingleUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleUnderlying Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case NewOrderSingle.TAG_UnderlyingSecurityAltIDSource:
	...
	public class NewOrderSingleUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private NewOrderSingleUnderlyingSecurityAltID _last;

		public NewOrderSingleUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderSingleStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderSingle.TAG_StipulationType:
						return _sStipulationType;
					case NewOrderSingle.TAG_StipulationValue:
	...
	public class NewOrderSingleStipulationList
	{
		private ArrayList _al;
		private NewOrderSingleStipulation _last;

		public NewOrderSingleStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderSingleStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderSingleStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderSingleStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderSingleStipulation Last
		{
			get { return _last; }
		}
	}
