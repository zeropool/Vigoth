...
{
	/// <summary>
	/// Summary description for NewOrderMultileg.
	/// </summary>
	public class NewOrderMultileg : Message
	{
		...
		private NewOrderMultilegPartyIDList _listPartyID = new NewOrderMultilegPartyIDList();
		...
		private NewOrderMultilegAllocList _listAlloc = new NewOrderMultilegAllocList();
		...
		private NewOrderMultilegTradingSessionList _listTradingSession = new NewOrderMultilegTradingSessionList();
		...
		private NewOrderMultilegSecurityAltIDList _listSecurityAltID = new NewOrderMultilegSecurityAltIDList();
		...
		private NewOrderMultilegEventList _listEvent = new NewOrderMultilegEventList();
		private DateTime _dtDatedDate;
		private DateTime _dtInterestAccrualDate;
		private int _iNoUnderlyings;
		private NewOrderMultilegUnderlyingList _listUnderlying = new NewOrderMultilegUnderlyingList();
		private double _dPrevClosePx;
		private int _iNoLegs;
		private NewOrderMultilegLegList _listLeg = new NewOrderMultilegLegList();
		...
		{
			_sMsgType = Values.MsgType.NewOrderMultileg;
		}
		...
		public NewOrderMultilegPartyIDList PartyID 
		{
		...
		public NewOrderMultilegAllocList Alloc 
		{
		...
		public NewOrderMultilegTradingSessionList TradingSession 
		{
		...
		public NewOrderMultilegSecurityAltIDList SecurityAltID 
		{
		...
		public NewOrderMultilegEventList Event 
		{
		...
		public NewOrderMultilegUnderlyingList Underlying 
		{
		...
		public NewOrderMultilegLegList Leg 
		{
			get { return _listLeg; }
		}
	...
	public class NewOrderMultilegPartyID
	{
		private string _sPartyID;
		private char _cPartyIDSource;
		private int _iPartyRole;
		private int _iNoPartySubIDs;
		private NewOrderMultilegPartySubIDList _listPartySubID = new NewOrderMultilegPartySubIDList();
		...
		public NewOrderMultilegPartySubIDList PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_PartyID:
						return _sPartyID;
					case NewOrderMultileg.TAG_PartyIDSource:
						return _cPartyIDSource;
					case NewOrderMultileg.TAG_PartyRole:
						return _iPartyRole;
					case NewOrderMultileg.TAG_NoPartySubIDs:
	...
	public class NewOrderMultilegPartyIDList
	{
		private ArrayList _al;
		private NewOrderMultilegPartyID _last;

		public NewOrderMultilegPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegPartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_PartySubID:
						return _sPartySubID;
					case NewOrderMultileg.TAG_PartySubIDType:
	...
	public class NewOrderMultilegPartySubIDList
	{
		private ArrayList _al;
		private NewOrderMultilegPartySubID _last;

		public NewOrderMultilegPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegPartySubID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegAlloc
	{
		...
		private NewOrderMultilegNested3PartyIDList _listNested3PartyID = new NewOrderMultilegNested3PartyIDList();
		...
		public NewOrderMultilegNested3PartyIDList Nested3PartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_AllocAccount:
						return _sAllocAccount;
					case NewOrderMultileg.TAG_AllocAcctIDSource:
						return _iAllocAcctIDSource;
					case NewOrderMultileg.TAG_AllocSettlCurrency:
						return _sAllocSettlCurrency;
					case NewOrderMultileg.TAG_IndividualAllocID:
						return _sIndividualAllocID;
					case NewOrderMultileg.TAG_NoNested3PartyIDs:
						return _iNoNested3PartyIDs;
					case NewOrderMultileg.TAG_AllocQty:
						return _iAllocQty;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class NewOrderMultilegAllocList
	{
		private ArrayList _al;
		private NewOrderMultilegAlloc _last;

		public NewOrderMultilegAlloc this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegAlloc)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegAlloc item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegAlloc item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegAlloc Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNested3PartyID
	{
		...
		private NewOrderMultilegNested3PartySubIDList _listNested3PartySubID = new NewOrderMultilegNested3PartySubIDList();
		...
		public NewOrderMultilegNested3PartySubIDList Nested3PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_Nested3PartyID:
						return _sNested3PartyID;
					case NewOrderMultileg.TAG_Nested3PartyIDSource:
						return _cNested3PartyIDSource;
					case NewOrderMultileg.TAG_Nested3PartyRole:
						return _iNested3PartyRole;
					case NewOrderMultileg.TAG_NoNested3PartySubIDs:
	...
	public class NewOrderMultilegNested3PartyIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNested3PartyID _last;

		public NewOrderMultilegNested3PartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNested3PartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNested3PartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNested3PartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNested3PartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNested3PartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_Nested3PartySubID:
						return _sNested3PartySubID;
					case NewOrderMultileg.TAG_Nested3PartySubIDType:
	...
	public class NewOrderMultilegNested3PartySubIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNested3PartySubID _last;

		public NewOrderMultilegNested3PartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNested3PartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNested3PartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNested3PartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNested3PartySubID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegTradingSession
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_TradingSessionID:
						return _sTradingSessionID;
					case NewOrderMultileg.TAG_TradingSessionSubID:
	...
	public class NewOrderMultilegTradingSessionList
	{
		private ArrayList _al;
		private NewOrderMultilegTradingSession _last;

		public NewOrderMultilegTradingSession this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegTradingSession)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegTradingSession item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegTradingSession item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegTradingSession Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_SecurityAltID:
						return _sSecurityAltID;
					case NewOrderMultileg.TAG_SecurityAltIDSource:
	...
	public class NewOrderMultilegSecurityAltIDList
	{
		private ArrayList _al;
		private NewOrderMultilegSecurityAltID _last;

		public NewOrderMultilegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegEvent
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_EventType:
						return _iEventType;
					case NewOrderMultileg.TAG_EventDate:
						return _dtEventDate;
					case NewOrderMultileg.TAG_EventPx:
						return _dEventPx;
					case NewOrderMultileg.TAG_EventText:
						return _sEventText;
					default:
						throw new Exception("Unknown field");
				}
	...
	public class NewOrderMultilegEventList
	{
		private ArrayList _al;
		private NewOrderMultilegEvent _last;

		public NewOrderMultilegEvent this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegEvent)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegEvent item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegEvent item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegEvent Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegUnderlying
	{
		...
		private NewOrderMultilegUnderlyingSecurityAltIDList _listUnderlyingSecurityAltID = new NewOrderMultilegUnderlyingSecurityAltIDList();
		...
		public NewOrderMultilegUnderlyingSecurityAltIDList UnderlyingSecurityAltID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_UnderlyingSymbol:
						return _sUnderlyingSymbol;
					case NewOrderMultileg.TAG_UnderlyingSymbolSfx:
						return _sUnderlyingSymbolSfx;
					case NewOrderMultileg.TAG_UnderlyingSecurityID:
						return _sUnderlyingSecurityID;
					case NewOrderMultileg.TAG_UnderlyingSecurityIDSource:
						return _sUnderlyingSecurityIDSource;
					case NewOrderMultileg.TAG_NoUnderlyingSecurityAltID:
						return _iNoUnderlyingSecurityAltID;
					case NewOrderMultileg.TAG_UnderlyingProduct:
						return _iUnderlyingProduct;
					case NewOrderMultileg.TAG_UnderlyingCFICode:
						return _sUnderlyingCFICode;
					case NewOrderMultileg.TAG_UnderlyingSecurityType:
						return _sUnderlyingSecurityType;
					case NewOrderMultileg.TAG_UnderlyingSecuritySubType:
						return _sUnderlyingSecuritySubType;
					case NewOrderMultileg.TAG_UnderlyingMaturityMonthYear:
						return _dtUnderlyingMaturityMonthYear;
					case NewOrderMultileg.TAG_UnderlyingMaturityDate:
						return _dtUnderlyingMaturityDate;
					case NewOrderMultileg.TAG_UnderlyingCouponPaymentDate:
						return _dtUnderlyingCouponPaymentDate;
					case NewOrderMultileg.TAG_UnderlyingIssueDate:
						return _dtUnderlyingIssueDate;
					case NewOrderMultileg.TAG_UnderlyingRepoCollateralSecurityType:
						return _iUnderlyingRepoCollateralSecurityType;
					case NewOrderMultileg.TAG_UnderlyingRepurchaseTerm:
						return _iUnderlyingRepurchaseTerm;
					case NewOrderMultileg.TAG_UnderlyingRepurchaseRate:
						return _dUnderlyingRepurchaseRate;
					case NewOrderMultileg.TAG_UnderlyingFactor:
						return _dUnderlyingFactor;
					case NewOrderMultileg.TAG_UnderlyingCreditRating:
						return _sUnderlyingCreditRating;
					case NewOrderMultileg.TAG_UnderlyingInstrRegistry:
						return _sUnderlyingInstrRegistry;
					case NewOrderMultileg.TAG_UnderlyingCountryOfIssue:
						return _sUnderlyingCountryOfIssue;
					case NewOrderMultileg.TAG_UnderlyingStateOrProvinceOfIssue:
						return _sUnderlyingStateOrProvinceOfIssue;
					case NewOrderMultileg.TAG_UnderlyingLocaleOfIssue:
						return _sUnderlyingLocaleOfIssue;
					case NewOrderMultileg.TAG_UnderlyingRedemptionDate:
						return _dtUnderlyingRedemptionDate;
					case NewOrderMultileg.TAG_UnderlyingStrikePrice:
						return _dUnderlyingStrikePrice;
					case NewOrderMultileg.TAG_UnderlyingStrikeCurrency:
						return _sUnderlyingStrikeCurrency;
					case NewOrderMultileg.TAG_UnderlyingOptAttribute:
						return _cUnderlyingOptAttribute;
					case NewOrderMultileg.TAG_UnderlyingContractMultiplier:
						return _dUnderlyingContractMultiplier;
					case NewOrderMultileg.TAG_UnderlyingCouponRate:
						return _dUnderlyingCouponRate;
					case NewOrderMultileg.TAG_UnderlyingSecurityExchange:
						return _sUnderlyingSecurityExchange;
					case NewOrderMultileg.TAG_UnderlyingIssuer:
						return _sUnderlyingIssuer;
					case NewOrderMultileg.TAG_EncodedUnderlyingIssuerLen:
						return _iEncodedUnderlyingIssuerLen;
					case NewOrderMultileg.TAG_EncodedUnderlyingIssuer:
						return _sEncodedUnderlyingIssuer;
					case NewOrderMultileg.TAG_UnderlyingSecurityDesc:
						return _sUnderlyingSecurityDesc;
					case NewOrderMultileg.TAG_EncodedUnderlyingSecurityDescLen:
						return _iEncodedUnderlyingSecurityDescLen;
					case NewOrderMultileg.TAG_EncodedUnderlyingSecurityDesc:
						return _sEncodedUnderlyingSecurityDesc;
					case NewOrderMultileg.TAG_UnderlyingCPProgram:
						return _sUnderlyingCPProgram;
					case NewOrderMultileg.TAG_UnderlyingCPRegType:
						return _sUnderlyingCPRegType;
					case NewOrderMultileg.TAG_UnderlyingCurrency:
						return _sUnderlyingCurrency;
					case NewOrderMultileg.TAG_UnderlyingQty:
						return _iUnderlyingQty;
					case NewOrderMultileg.TAG_UnderlyingPx:
						return _dUnderlyingPx;
					case NewOrderMultileg.TAG_UnderlyingDirtyPrice:
						return _dUnderlyingDirtyPrice;
					case NewOrderMultileg.TAG_UnderlyingEndPrice:
						return _dUnderlyingEndPrice;
					case NewOrderMultileg.TAG_UnderlyingStartValue:
						return _dUnderlyingStartValue;
					case NewOrderMultileg.TAG_UnderlyingCurrentValue:
						return _dUnderlyingCurrentValue;
					case NewOrderMultileg.TAG_UnderlyingEndValue:
	...
	public class NewOrderMultilegUnderlyingList
	{
		private ArrayList _al;
		private NewOrderMultilegUnderlying _last;

		public NewOrderMultilegUnderlying this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegUnderlying)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegUnderlying item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegUnderlying item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegUnderlying Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegUnderlyingSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_UnderlyingSecurityAltID:
						return _sUnderlyingSecurityAltID;
					case NewOrderMultileg.TAG_UnderlyingSecurityAltIDSource:
	...
	public class NewOrderMultilegUnderlyingSecurityAltIDList
	{
		private ArrayList _al;
		private NewOrderMultilegUnderlyingSecurityAltID _last;

		public NewOrderMultilegUnderlyingSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegUnderlyingSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegUnderlyingSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegUnderlyingSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegUnderlyingSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegLeg
	{
		...
		private NewOrderMultilegLegSecurityAltIDList _listLegSecurityAltID = new NewOrderMultilegLegSecurityAltIDList();
		...
		private NewOrderMultilegLegStipulationList _listLegStipulation = new NewOrderMultilegLegStipulationList();
		private int _iNoLegAllocs;
		private NewOrderMultilegLegAllocList _listLegAlloc = new NewOrderMultilegLegAllocList();
		private char _cLegPositionEffect;
		private int _iLegCoveredOrUncovered;
		private int _iNoNestedPartyIDs;
		private NewOrderMultilegNestedPartyIDList _listNestedPartyID = new NewOrderMultilegNestedPartyIDList();
		...
		public NewOrderMultilegLegSecurityAltIDList LegSecurityAltID 
		{
		...
		public NewOrderMultilegLegStipulationList LegStipulation 
		{
		...
		public NewOrderMultilegLegAllocList LegAlloc 
		{
		...
		public NewOrderMultilegNestedPartyIDList NestedPartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_LegSymbol:
						return _sLegSymbol;
					case NewOrderMultileg.TAG_LegSymbolSfx:
						return _sLegSymbolSfx;
					case NewOrderMultileg.TAG_LegSecurityID:
						return _sLegSecurityID;
					case NewOrderMultileg.TAG_LegSecurityIDSource:
						return _sLegSecurityIDSource;
					case NewOrderMultileg.TAG_NoLegSecurityAltID:
						return _iNoLegSecurityAltID;
					case NewOrderMultileg.TAG_LegProduct:
						return _iLegProduct;
					case NewOrderMultileg.TAG_LegCFICode:
						return _sLegCFICode;
					case NewOrderMultileg.TAG_LegSecurityType:
						return _sLegSecurityType;
					case NewOrderMultileg.TAG_LegSecuritySubType:
						return _sLegSecuritySubType;
					case NewOrderMultileg.TAG_LegMaturityMonthYear:
						return _dtLegMaturityMonthYear;
					case NewOrderMultileg.TAG_LegMaturityDate:
						return _dtLegMaturityDate;
					case NewOrderMultileg.TAG_LegCouponPaymentDate:
						return _dtLegCouponPaymentDate;
					case NewOrderMultileg.TAG_LegIssueDate:
						return _dtLegIssueDate;
					case NewOrderMultileg.TAG_LegRepoCollateralSecurityType:
						return _iLegRepoCollateralSecurityType;
					case NewOrderMultileg.TAG_LegRepurchaseTerm:
						return _iLegRepurchaseTerm;
					case NewOrderMultileg.TAG_LegRepurchaseRate:
						return _dLegRepurchaseRate;
					case NewOrderMultileg.TAG_LegFactor:
						return _dLegFactor;
					case NewOrderMultileg.TAG_LegCreditRating:
						return _sLegCreditRating;
					case NewOrderMultileg.TAG_LegInstrRegistry:
						return _sLegInstrRegistry;
					case NewOrderMultileg.TAG_LegCountryOfIssue:
						return _sLegCountryOfIssue;
					case NewOrderMultileg.TAG_LegStateOrProvinceOfIssue:
						return _sLegStateOrProvinceOfIssue;
					case NewOrderMultileg.TAG_LegLocaleOfIssue:
						return _sLegLocaleOfIssue;
					case NewOrderMultileg.TAG_LegRedemptionDate:
						return _dtLegRedemptionDate;
					case NewOrderMultileg.TAG_LegStrikePrice:
						return _dLegStrikePrice;
					case NewOrderMultileg.TAG_LegStrikeCurrency:
						return _sLegStrikeCurrency;
					case NewOrderMultileg.TAG_LegOptAttribute:
						return _cLegOptAttribute;
					case NewOrderMultileg.TAG_LegContractMultiplier:
						return _dLegContractMultiplier;
					case NewOrderMultileg.TAG_LegCouponRate:
						return _dLegCouponRate;
					case NewOrderMultileg.TAG_LegSecurityExchange:
						return _sLegSecurityExchange;
					case NewOrderMultileg.TAG_LegIssuer:
						return _sLegIssuer;
					case NewOrderMultileg.TAG_EncodedLegIssuerLen:
						return _iEncodedLegIssuerLen;
					case NewOrderMultileg.TAG_EncodedLegIssuer:
						return _sEncodedLegIssuer;
					case NewOrderMultileg.TAG_LegSecurityDesc:
						return _sLegSecurityDesc;
					case NewOrderMultileg.TAG_EncodedLegSecurityDescLen:
						return _iEncodedLegSecurityDescLen;
					case NewOrderMultileg.TAG_EncodedLegSecurityDesc:
						return _sEncodedLegSecurityDesc;
					case NewOrderMultileg.TAG_LegRatioQty:
						return _dLegRatioQty;
					case NewOrderMultileg.TAG_LegSide:
						return _cLegSide;
					case NewOrderMultileg.TAG_LegCurrency:
						return _sLegCurrency;
					case NewOrderMultileg.TAG_LegPool:
						return _sLegPool;
					case NewOrderMultileg.TAG_LegDatedDate:
						return _dtLegDatedDate;
					case NewOrderMultileg.TAG_LegContractSettlMonth:
						return _dtLegContractSettlMonth;
					case NewOrderMultileg.TAG_LegInterestAccrualDate:
						return _dtLegInterestAccrualDate;
					case NewOrderMultileg.TAG_LegQty:
						return _iLegQty;
					case NewOrderMultileg.TAG_LegSwapType:
						return _iLegSwapType;
					case NewOrderMultileg.TAG_NoLegStipulations:
						return _iNoLegStipulations;
					case NewOrderMultileg.TAG_NoLegAllocs:
						return _iNoLegAllocs;
					case NewOrderMultileg.TAG_LegPositionEffect:
						return _cLegPositionEffect;
					case NewOrderMultileg.TAG_LegCoveredOrUncovered:
						return _iLegCoveredOrUncovered;
					case NewOrderMultileg.TAG_NoNestedPartyIDs:
						return _iNoNestedPartyIDs;
					case NewOrderMultileg.TAG_LegRefID:
						return _sLegRefID;
					case NewOrderMultileg.TAG_LegPrice:
						return _dLegPrice;
					case NewOrderMultileg.TAG_LegSettlType:
						return _cLegSettlType;
					case NewOrderMultileg.TAG_LegSettlDate:
	...
	public class NewOrderMultilegLegList
	{
		private ArrayList _al;
		private NewOrderMultilegLeg _last;

		public NewOrderMultilegLeg this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegLeg)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegLeg item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegLeg item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegLeg Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegLegSecurityAltID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_LegSecurityAltID:
						return _sLegSecurityAltID;
					case NewOrderMultileg.TAG_LegSecurityAltIDSource:
	...
	public class NewOrderMultilegLegSecurityAltIDList
	{
		private ArrayList _al;
		private NewOrderMultilegLegSecurityAltID _last;

		public NewOrderMultilegLegSecurityAltID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegLegSecurityAltID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegLegSecurityAltID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegLegSecurityAltID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegLegSecurityAltID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegLegStipulation
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_LegStipulationType:
						return _sLegStipulationType;
					case NewOrderMultileg.TAG_LegStipulationValue:
	...
	public class NewOrderMultilegLegStipulationList
	{
		private ArrayList _al;
		private NewOrderMultilegLegStipulation _last;

		public NewOrderMultilegLegStipulation this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegLegStipulation)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegLegStipulation item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegLegStipulation item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegLegStipulation Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegLegAlloc
	{
		private string _sLegAllocAccount;
		private string _sLegIndividualAllocID;
		private int _iNoNested2PartyIDs;
		private NewOrderMultilegNested2PartyIDList _listNested2PartyID = new NewOrderMultilegNested2PartyIDList();
		...
		public NewOrderMultilegNested2PartyIDList Nested2PartyID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_LegAllocAccount:
						return _sLegAllocAccount;
					case NewOrderMultileg.TAG_LegIndividualAllocID:
						return _sLegIndividualAllocID;
					case NewOrderMultileg.TAG_NoNested2PartyIDs:
						return _iNoNested2PartyIDs;
					case NewOrderMultileg.TAG_LegAllocQty:
						return _iLegAllocQty;
					case NewOrderMultileg.TAG_LegAllocAcctIDSource:
						return _sLegAllocAcctIDSource;
					case NewOrderMultileg.TAG_LegSettlCurrency:
	...
	public class NewOrderMultilegLegAllocList
	{
		private ArrayList _al;
		private NewOrderMultilegLegAlloc _last;

		public NewOrderMultilegLegAlloc this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegLegAlloc)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegLegAlloc item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegLegAlloc item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegLegAlloc Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNested2PartyID
	{
		...
		private NewOrderMultilegNested2PartySubIDList _listNested2PartySubID = new NewOrderMultilegNested2PartySubIDList();
		...
		public NewOrderMultilegNested2PartySubIDList Nested2PartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_Nested2PartyID:
						return _sNested2PartyID;
					case NewOrderMultileg.TAG_Nested2PartyIDSource:
						return _cNested2PartyIDSource;
					case NewOrderMultileg.TAG_Nested2PartyRole:
						return _iNested2PartyRole;
					case NewOrderMultileg.TAG_NoNested2PartySubIDs:
	...
	public class NewOrderMultilegNested2PartyIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNested2PartyID _last;

		public NewOrderMultilegNested2PartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNested2PartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNested2PartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNested2PartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNested2PartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNested2PartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_Nested2PartySubID:
						return _sNested2PartySubID;
					case NewOrderMultileg.TAG_Nested2PartySubIDType:
	...
	public class NewOrderMultilegNested2PartySubIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNested2PartySubID _last;

		public NewOrderMultilegNested2PartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNested2PartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNested2PartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNested2PartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNested2PartySubID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNestedPartyID
	{
		...
		private NewOrderMultilegNestedPartySubIDList _listNestedPartySubID = new NewOrderMultilegNestedPartySubIDList();
		...
		public NewOrderMultilegNestedPartySubIDList NestedPartySubID 
		{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_NestedPartyID:
						return _sNestedPartyID;
					case NewOrderMultileg.TAG_NestedPartyIDSource:
						return _cNestedPartyIDSource;
					case NewOrderMultileg.TAG_NestedPartyRole:
						return _iNestedPartyRole;
					case NewOrderMultileg.TAG_NoNestedPartySubIDs:
	...
	public class NewOrderMultilegNestedPartyIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNestedPartyID _last;

		public NewOrderMultilegNestedPartyID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNestedPartyID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNestedPartyID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNestedPartyID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNestedPartyID Last
		{
			get { return _last; }
		}
	}

	public class NewOrderMultilegNestedPartySubID
	{
		...
		public object this[int iTag]
		{
			get
			{
				switch (iTag)
				{
					case NewOrderMultileg.TAG_NestedPartySubID:
						return _sNestedPartySubID;
					case NewOrderMultileg.TAG_NestedPartySubIDType:
	...
	public class NewOrderMultilegNestedPartySubIDList
	{
		private ArrayList _al;
		private NewOrderMultilegNestedPartySubID _last;

		public NewOrderMultilegNestedPartySubID this[int i]
		{
			get
			{
				if (_al != null && i < _al.Count)
					return (NewOrderMultilegNestedPartySubID)_al[i];
				else
					return null;
			}
		}
		...
		public void Add(NewOrderMultilegNestedPartySubID item)
		{
			if (_al == null)
				_al = new ArrayList();
			_al.Add(item);
		...
		public void Remove(NewOrderMultilegNestedPartySubID item)
		{
			if (_al != null)
				_al.Remove(item);
		}
		...
		public NewOrderMultilegNestedPartySubID Last
		{
			get { return _last; }
		}
	}
