...
namespace VigiothCapital.QuantTrader.Brokerages.Fxcm
{
    ...
    public partial class FxcmBrokerage
    {
        ...
        /// <summary>
        /// Converts an FXCM OrderStatus to a VigiothCapital.QuantTrader <see cref="OrderStatus"/>
        /// </summary>
        ...
        //
        // So it turns out that in order to properly load the VigiothCapital.QuantTrader.Brokerages
