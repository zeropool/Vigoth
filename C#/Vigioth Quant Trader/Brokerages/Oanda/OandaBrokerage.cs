...
using VigiothCapital.QuantTrader.Brokerages.Oanda.Framework;
using VigiothCapital.QuantTrader.Brokerages.Oanda.Session;
...
using Order = VigiothCapital.QuantTrader.Orders.Order;
