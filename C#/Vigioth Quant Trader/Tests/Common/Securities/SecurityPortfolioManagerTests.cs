...
namespace VigiothCapital.QuantTrader.Tests.Common.Securities
{
    ...
    public class SecurityPortfolioManagerTests
    {
        ...
        public void MarginComputesProperlyWithMultipleSecurities()
        {
            ...
            securities.Add(new VigiothCapital.QuantTrader.Securities.Forex.Forex(SecurityExchangeHours, usdCash, config2, SymbolProperties.GetDefault(CashBook.AccountCurrency)));
            ...
            securities.Add(new VigiothCapital.QuantTrader.Securities.Forex.Forex(SecurityExchangeHours, gbpCash, config3, SymbolProperties.GetDefault(gbpCash.Symbol)));
        ...
        public void ForexFillUpdatesCashCorrectly()
        {
            ...
            securities.Add(Symbols.EURUSD, new VigiothCapital.QuantTrader.Securities.Forex.Forex(SecurityExchangeHours, portfolio.CashBook["USD"], CreateTradeBarDataConfig(SecurityType.Forex, Symbols.EURUSD), SymbolProperties.GetDefault(CashBook.AccountCurrency)));
        ...
        public void EquitySellAppliesSettlementCorrectly()
        {
            ...
            var portfolio = new SecurityPortfolioManager(securities, transactions);
            portfolio.SetCash(1000);
            securities.Add(Symbols.AAPL, new VigiothCapital.QuantTrader.Securities.Equity.Equity(securityExchangeHours, CreateTradeBarDataConfig(SecurityType.Equity, Symbols.AAPL), new Cash(CashBook.AccountCurrency, 0, 1m), SymbolProperties.GetDefault(CashBook.AccountCurrency)));
            var security = securities[Symbols.AAPL];
