...
namespace VigiothCapital.QuantTrader.Tests.Common
{
    ...
    public class SymbolTests
    {
        ...
        {
            const string json = @"{'$type':'System.Collections.Generic.List`1[[VigiothCapital.QuantTrader.Data.BaseData, VigiothCapital.QuantTrader.Common]], mscorlib',
'$values':[{'$type':'VigiothCapital.QuantTrader.Data.Market.Tick, VigiothCapital.QuantTrader.Common',
...
'Symbol':{'$type':'VigiothCapital.QuantTrader.Symbol, VigiothCapital.QuantTrader.Common',
'Value':'EURGBP',
'ID':'EURGBP 5O'},'Value':0.72722,'Price':0.72722}]}";
        ...
        public void HandlesListTicksWithDifferentSymbols()
        {
            ...
            const string json =
                "{'$type':'System.Collections.Generic.List`1[[VigiothCapital.QuantTrader.Data.BaseData, VigiothCapital.QuantTrader.Common]], mscorlib','$values':[" +

                    "{'$type':'VigiothCapital.QuantTrader.Data.Market.Tick, VigiothCapital.QuantTrader.Common'," +
                    ...
                    "'Symbol':{'$type':'VigiothCapital.QuantTrader.Symbol, VigiothCapital.QuantTrader.Common','Value':'EURUSD', 'ID': 'EURUSD 5O'}," +
                    ...
                    "'Symbol':{'$type':'VigiothCapital.QuantTrader.Symbol, VigiothCapital.QuantTrader.Common','Value':'EURGBP', 'ID': 'EURGBP 5O'}," +
        ...
        {
            const string json = @"{'$type':'VigiothCapital.QuantTrader.Symbol, VigiothCapital.QuantTrader.Common', 'Value':'EURGBP', 'ID': 'EURGBP 5O'}";
            var expected = new Symbol(SecurityIdentifier.GenerateForex("EURGBP", Market.FXCM), "EURGBP");
            var actual = JsonConvert.DeserializeObject<Symbol>(json, Settings);
            Assert.AreEqual(expected, actual);
        }
