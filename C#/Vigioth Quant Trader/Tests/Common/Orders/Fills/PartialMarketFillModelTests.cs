...
using VigiothCapital.QuantTrader.Algorithm.CSharp;
...
using VigiothCapital.QuantTrader.Tests.Engine;

namespace VigiothCapital.QuantTrader.Tests.Common.Orders.Fills
{
    [TestFixture, Ignore]
