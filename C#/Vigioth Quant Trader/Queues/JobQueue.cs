...
namespace VigiothCapital.QuantTrader.Queues
{
    ...
    {
        // The type name of the VigiothCapital.QuantTrader.Brokerages.Paper.PaperBrokerage
        ...
        private string AlgorithmLocation
        {
            get
            {
                ...
                return Config.Get("algorithm-location", "VigiothCapital.QuantTrader.Algorithm.CSharp.dll"); 
            }
        }
