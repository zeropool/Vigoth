...
namespace VigiothCapital.QuantTrader.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        private DateTime GetStartTimeAlgoTz(Symbol symbol, int periods, Resolution? resolution = null)
        {
            ...
            timeSpan = timeSpan < VigiothCapital.QuantTrader.Time.OneSecond ? VigiothCapital.QuantTrader.Time.OneSecond : timeSpan;
            var localStartTime = VigiothCapital.QuantTrader.Time.GetStartTimeForTradeBars(security.Exchange.Hours, UtcTime.ConvertFromUtc(security.Exchange.TimeZone), timeSpan, periods, security.IsExtendedMarketHours);
